...
#define i_max_of_string_of_mixer 10000000000
...
void* make_in_to_a_folder(char *name_of_folder, struct list_of_Accounts_of_Amount *i_head_amount)
{
    ...
    while (counter_0 < len_)
    {
        ...
        else
        {
            ...
            char content[i_macro_of_Number_max_of_word_byte];
            
            str_number_1(content, &(i_head_amount->amount));
