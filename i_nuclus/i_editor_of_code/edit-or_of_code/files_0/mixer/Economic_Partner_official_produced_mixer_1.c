...
#define i_macro_of_number_of_digite_maximum_after_the_floating_point 540
...
#define i_macro_of_length_of_encoding "100"
...
#define i_max_of_string_of_mixer 1000000000
...
int main()
{
    ...
    char *i_string_1 = malloc(200), *i_string_2 = malloc(200), *i_string_4 = malloc(200);
    ...
    while (run == true)
    {
        ...
        make_in_to_a_folder("space_for_mix", i_head_amount);
