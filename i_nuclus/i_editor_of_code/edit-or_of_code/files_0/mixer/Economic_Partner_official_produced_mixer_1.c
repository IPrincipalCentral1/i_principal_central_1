...
void* make_in_to_a_folder(char *name_of_folder, struct list_of_Accounts_of_Amount *i_head_amount)
{
    ...
    while (counter_0 < len_)
    {
        ...
        strcpy(i_cwd, name_of_folder);
        
        
        strcpy(i_cwd, "/file_part_");
        
        
        strcpy(i_cwd, int_ND_to_str_1(counter_0, number_in_file));
        
        
        strcpy(i_cwd, ".mixer");
        
        
        printf("i_cwd = %s", i_cwd);
...
int main()
{
    ...
    struct number n_1, length_on_number, i_n_2, n3;
    ...
    n_1.num[i_macro_of_Number_max_of_word_byte - 1] = 0;
