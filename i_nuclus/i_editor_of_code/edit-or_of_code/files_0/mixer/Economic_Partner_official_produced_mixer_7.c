...
#define i_macro_of_Number_max_of_word_byte 125 //___number_of_chunk___



#define i_macro_of_length_of_encoding "5" //"___postion_of_max_range___"
...
void* read_from_a_folder(char *name_of_folder, struct list_of_Accounts_of_Amount **i_head_amount)
{
    ...
    struct number n_0, maximum_, n_1;
        ...
        while ((counter_1 < counter_0) && (run_ == true))
        {
            ...
            if (file) 
            {
                ...
                if (counter_1 == 0)
                {
                    ...
                    int_copy(&((*i_head_amount)->amount), &n_1);
                ...
                else
                {
                    ...
                    add_ele_list_of_Accounts_of_Amount(i_head_amount, (*i_head_amount)->unity, &n_1, len_list_of_Accounts_of_Amount(*i_head_amount));
