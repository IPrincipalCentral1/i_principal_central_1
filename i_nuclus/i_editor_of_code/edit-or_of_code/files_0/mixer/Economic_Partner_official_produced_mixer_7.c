    ...
    if (continue_ == true)
    {
        ...
        while (counter_1 < counter_0)
        {
            ...
            if (file) 
            {
                ...
                add_ele_list_of_Accounts_of_Amount(i_head_amount, i_name_of_unity_of_encoding, &n_1, len_list_of_Accounts_of_Amount(*i_head_amount));
