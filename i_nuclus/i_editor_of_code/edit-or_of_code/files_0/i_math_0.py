...
if (i["i am you"] == True):
    ...
    def invers_cos(a, type_of_angle="", pi=""):
    ...
    def invers_sin(b, type_of_angle="", pi=""):
    ...
    def cos(alpha, number_of_digit_after_the_floating_point_1):
        ...
        #delta = f"(((-2 * (1 - {alpha}) ^ 4 + 2 * ({alpha} ^ 2) * ((1 - {alpha}) ^ 2)) ^ 2) - (4 * ((1 - {alpha}) ^ 4 + {alpha} ^ 4) * ({alpha} ^ 4 + (1 - {alpha}) ^ 4 - 2 * ({alpha} ^ 2) * ((1 - {alpha}) ^ 2) - {alpha} ^ 4)))"
        
        delta = f"(({str_b} ^ 2) - 4 * {str_a} * {str_c})"
        
        
        
        m = calculatrice_2(s=oper, l_=[], n=0, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point_1, e=False)
    ...
    if __name__ == "__main__":
        ...
        oper = invers_sin(b="(3 / (4))", type_of_angle="", pi="3.14")
        ...
        str_0 = cos(alpha=alpha, number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point)
