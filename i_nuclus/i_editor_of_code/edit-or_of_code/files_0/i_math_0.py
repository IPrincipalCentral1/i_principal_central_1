...
if (i["i am you"] == True):
    ...
    def sin(alpha_, number_of_digit_after_the_floating_point_1, type_of_angle=""):
        ...
        cos_ = cos(alpha_=alpha_, number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point_1, type_of_angle=type_of_angle)
    
    
        if (cos_ != ""):
    
            operation = f"((1 - {cos_} ^ 2) R 2)"
