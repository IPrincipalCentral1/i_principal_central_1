...
#define i_macro_of_number_of_digite_maximum_after_the_floating_point ___i_macro_of_number_of_digite_maximum_after_the_floating_point___
...
int main()
{
    ...
    char *i_string_1 = malloc(2000), *i_string_2 = malloc(2000), *i_string_4 = malloc(2000), *name_of_folder = malloc(1000), *i_string_5 = malloc(2000), *i_string_6 = malloc(2000);


    strcpy(i_string_1, "i_run_mixer_1.txt");

    strcpy(i_string_2, "true");
    
    strcpy(i_string_4, "i_mix_of_mixer_1.i_mixer");
    
    strcpy(i_string_5, "this file should contain just 'true' to make the mixer stop");
    
    strcpy(i_string_6, "i_run_mixer_2.txt");
    

    
    strcpy(name_of_folder, "space_for_mix");
    ...
    char *i_string_3 = malloc(10000 + 1), *i_string_0 = malloc(10000);


    char *file_path = malloc(255 + PATH_MAX), *path_of_file_1 = malloc(255 + PATH_MAX);


    char i_cwd[PATH_MAX];

    strcpy(path_of_file_1, "i_run_mixer_1.txt");


    strcpy(i_string_3, "this file should contain just 'true' for the mixer to make the next step");
    ...
    strcpy(file_path, i_cwd);
    
    strcat(file_path, "/"); 
    
    strcat(file_path, i_string_6); 
    
    
    
    save_ing_in_file(i_string_5, file_path);
    ...
    struct number n_1, length_on_number, i_n_2, n3, number_0;
    
    
    initialize_number(&i_n_2);
    
    i_n_2.num[i_macro_of_Number_max_of_word_byte - 1] = 0;
    
    

    initialize_number(&n_1);

    n_1.num[i_macro_of_Number_max_of_word_byte - 1] = 1;

        
    number_0.length_of_num = 0;
    

    number_str(i_macro_of_number_of_digite_maximum_after_the_floating_point, &number_0, i_macro_of_length_of_encoding);


    initialize_number(&length_on_number);


    print_number("number_0 = ", &number_0);



    int64_t counter_0 = number_0.length_of_num - 1;
    
    
    bool continue_ = true;
    
    if (counter_0  <  i_macro_of_Number_max_of_word_byte - 1)
    {
    ...
    else
    {
        ...
        printf("\n\n\nthe number of border of maximum number is too big\n\n\n");
    ...
    while (counter_0 >= 0)
    {
        ...
        length_on_number.num[i_macro_of_Number_max_of_word_byte - 1 + counter_0] = number_0.num[counter_0];
    
    
    
        printf("\n length_on_number.num[counter_0] = %ld . number_0.num[counter_0] = %ld . counter_0 = %ld . i_macro_of_Number_max_of_word_byte + counter_0 = %ld . \n", length_on_number.num[counter_0], number_0.num[counter_0], counter_0, i_macro_of_Number_max_of_word_byte + counter_0);
    ...
    printf("----------------------\n-------------------------------\n length_on_number.num[i_macro_of_Number_max_of_word_byte - 1] = %ld . \n", length_on_number.num[i_macro_of_Number_max_of_word_byte - 1]);




    //number_str(i_macro_of_number_of_digite_maximum_after_the_floating_point, &number_0, "1000000000000000000000000000000000000");
    ...
    str_number_1(s_2, &number_0);


    printf("\n\n\n\ns_2 = %s .\n\n\n\n", s_2);


    //length_on_number.num[i_macro_of_Number_max_of_word_byte - 1] = i_macro_of_length_of_encoding_int;
    ...
    while (i < 1)
    {
        ...
        add_ele_list_of_Accounts_of_Amount(&(i_head_amount), u, &n3, len_list_of_Accounts_of_Amount(i_head_amount));
    ...
    add_number(i_macro_of_number_of_digite_maximum_after_the_floating_point, &n2, &n1, &n);
    ...
    double i_float_ing_number = 0.0, i_round_per_second = 0.0, i_max_ = 0.0;

    int64_t i_counter = 0, i_counter_1 = 0, i_number_of_times = 100;

    bool run = continue_;


    read_from_a_folder(name_of_folder, &i_head_amount);


    make_in_to_a_folder(name_of_folder, i_head_amount);
    ...
    while (run == true)
    {
        ...
        strcat(file_path, i_string_1); 
        
        
        read_ing_in_file(i_string_0, file_path);
        
        
        
        //printf("\n\n i_hello_0 . file_path = %s . i_string_0 = %s . i_string_3 = %s .\n\n", file_path, i_string_0, i_string_3);
        
        if (char_equal_(i_string_0, i_string_2) == true)
        {
            ...
            next_step_in_mix_1(&(i_head_amount), &n_1, &i_n_2, &length_on_number, &n_0);
            ...
            strcat(file_path, path_of_file_1); 
            
        
        
            save_ing_in_file(i_string_3, file_path);
        ...
        //printf("\n\n i_hello_1 . file_path = %s . i_string_0 = %s . i_string_5 = %s .\n\n", file_path, i_string_0, i_string_5);
        ...
        i_float_ing_number = t2 - t1;

        if (i_float_ing_number == 0)
        {

            i_round_per_second = -1;

        }
        else
        {

            i_round_per_second = 1 / i_float_ing_number;

        }



        // printf("\n\ntime = %.10f second . len(i) = %ld . i_max_ = %.10f . i_round_per_second = %.10f .\n\n", i_float_ing_number, len_list_of_Accounts_of_Amount(i_head_amount), i_max_, i_round_per_second);


        //produce_string_fast_list_of_Accounts_of_Amount_1(i_head_amount, &i_string_3);
        ...
        // printf("\n\n\nproduce_string_fast_list_of_Accounts_of_Amount(i_head_amount) = %s .\n\n\n", i_string_3);


        // i_string_3 = malloc(20);


        // strcpy(i_string_3, "hello");
        ...
        if (t4 - t3 > 2)
        {
            ...
            // printf("\nstrlen(i_string_3) = %ld .\n", strlen(i_string_3));

            date_();

            printf("\n\ni_counter_1 = %ld . i_counter = %ld . counter_2 = %ld .\n\n", i_counter_1, i_counter, counter_2);

            print_fast_list_of_Accounts_of_Amount(i_head_amount);

            printf("\n\n\n\n");

            i_counter_1 = i_counter_1 + 1;
        ...
        if (i_max_ < i_round_per_second)
        {

            i_max_ = i_round_per_second;
        ...
        // if (i_counter == i_number_of_times)
        // {
    ...
    while (i < len_list_of_Accounts_of_Amount(i_head_amount))
    {
    
        print_list_of_Accounts_of_Amount_index(i_head_amount, i);
    ...
    i = len_list_of_Accounts_of_Amount(i_head_amount) - 1;
