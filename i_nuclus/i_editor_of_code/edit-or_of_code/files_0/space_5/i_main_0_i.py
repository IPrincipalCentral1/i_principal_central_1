...
# إنشاء بيانات المحاور
x = np.linspace(0, 10, 500)

# منحنيات الانحدار المختلفة
y1 = 10 - x                                 # مستقيم
y2 = 10 - np.sqrt(100 - (x - 10)**2)        # ربع دائرة (أخضر)
y3 = 10 - 0.5*x**1.5                        # منحنى بينهما
y4 = 10 - 1.2*np.sqrt(100 - (x - 10)**2)    # منحنى أعمق من الدائرة (أسفلها)

# موازنة النهاية حتى لا تنزل أكثر من اللزوم
y4 = y4 - (min(y4) - min(y2)) * 0.5         # ضبط العمق نسبيًا
...
ax.plot(x, y4, 'm', label="منحنى 4 (أعمق من الدائرة)")
ax.legend()
