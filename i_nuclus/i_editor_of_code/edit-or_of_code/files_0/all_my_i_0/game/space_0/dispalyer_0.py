...
class MyWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.i_image_to_read = os.path.join(cwd, "space_0", "photo", "black.png")
        ...
        image_0 = Image.open(self.i_image_to_read)
        
        image_0 = image_0.resize(self.size_of_img)
        
        image_0.save(self.i_image_to_read)
