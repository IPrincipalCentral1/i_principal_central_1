...
class MyWidget(QWidget):
    ...
    def __init__(self):
        ...
        metadata.add_text("Comment", "هذا النص مخفي في بيانات الصورة")
        ...
        print(f"img.text = {str(img.text)} ")  # سيعرض {"Comment": "هذا النص مخفي في بيانات الصورة"}
