...
class MyWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.the_head_of_the_snake = [120, 340]
        ...
        image_1.putpixel((self.the_head_of_the_snake[0], self.the_head_of_the_snake[1]), (0, 255, 0))
        ...
        metadata.add_text("head_of_the_snake", f"{self.the_head_of_the_snake[0]},{self.the_head_of_the_snake[1]}")
