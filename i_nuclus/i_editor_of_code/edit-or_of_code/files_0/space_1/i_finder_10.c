...
//wchar_t* str_from_UTF_8(wchar_t *wtext)
//{


    //size_t size = wcstombs(NULL, wtext, 0) + 1;

    //wchar_t *utf8_text = malloc(size);
...
wchar_t *str_from_UTF_8(const char *utf8_str) {
...
void add_element_list_of_element_1(struct list_of_element_1 **head, wchar_t *element_0, wchar_t *content_0, int64_t index)
{
    ...
    if (counter_0 == index)
    {
        ...
        if ((index == 0) || (q == NULL))
        {
            ...
            q->element_0 = (wchar_t *) malloc(wcslen(element_0) + 1);
            
            wcscpy(q->element_0, element_0);
            
            
            
            q->content_0 = (wchar_t *) malloc(wcslen(content_0) + 1);
        ...
        else
        {
            ...
            k->element_0 = (wchar_t *) malloc(wcslen(element_0) + 1);
            
            wcscpy(k->element_0, element_0);
            
            
            
            k->content_0 = (wchar_t *) malloc(wcslen(content_0) + 1);
