...
def i_builder_of_number_0(last_number, number_of_depth, times_number_1):
    ...
    return i_counter_1 * times_number_1
...
def main():
    ...
    i_v_3 = i_builder_of_number_0(last_number=i_v_1[0], number_of_depth=i_v_1[1], times_number_1=1)
    ...
    i_v_3 = i_builder_of_number_0(last_number=i_v_1[0], number_of_depth=i_v_1[1], times_number_1=1.2456)
