...
def i_builder_of_number_0(last_number, number_of_depth):
    ...
    while (0 <= number_of_depth):
        
        
        print(f"i_hello_0 . i_counter_0 = {i_counter_0} . i_counter_1 = {i_counter_1} .")
        
        i_counter_1 = ( 10 ** len(str(i_counter_1)) )
        
        
        print(f"i_hello_1 . i_counter_1 = {i_counter_1} .")
