...
def main():
    ...
    result_1 = i_inverse_reformater(the_content_to_make_the_reverse_on_it=result_0)
    ...
    string_1 = shift_0(content_to_shift=string_0, caractere=caracter_0)
    ...
    string_2 = unshift_0(content_to_shift=string_1, length_of_caractere=len(caracter_0))
