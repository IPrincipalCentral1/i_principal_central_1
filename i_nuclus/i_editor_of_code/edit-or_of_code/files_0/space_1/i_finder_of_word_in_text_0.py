...
def main():
    ...
    def finder_1(element_0, element_1):
        ...
        while (counter_0 < len(element_1)):
            ...
            print(f"i_hello_0 . len(element_0) = {len(element_0)} . (counter_1 * len(element_0)) = {(counter_1 * len(element_0))} .")
            
            while ((counter_0 - (counter_1 * len(element_0)) < len(element_0)) and (counter_0 < len(element_1)) and (element_0[counter_0 - (counter_1 * len(element_0))] == element_1[counter_0])):
