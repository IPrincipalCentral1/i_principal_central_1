...
this is the same as the previus one but it should have encoding .

you should put the specific encoding right here : ___type_of_encoding___
...
type_of_encoding = r"""___type_of_encoding___"""
...
try:
    ...
    try:
        ...
        if (os.path.exists(file_of_the_links_to_the_base_of_information_0) == True):
            ...
            with open(file_of_the_links_to_the_base_of_information_0, "r", encoding=type_of_encoding) as f_:
            ...
            with open(file_of_the_links_to_the_base_of_information_0, "w", encoding=type_of_encoding) as f_:
    ...
    try:
        ...
        if (os.path.exists(file_of_content_to_search_0) == True):
            ...
            with open(file_of_content_to_search_0, "r", encoding=type_of_encoding) as f_:
            ...
            with open(file_of_content_to_search_0, "w", encoding=type_of_encoding) as f_:
    ...
    with open(file_0, "w", encoding=type_of_encoding) as f_:
