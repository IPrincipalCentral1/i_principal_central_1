...
def finder_0(element_0, element_1):
    ...
    print(f"i_hello_1 . element_0 = ''{element_0}'' . element_1 = ''{element_1}'' .")
    ...
    while ((counter_0 < len(element_0)) and (counter_0 < len(element_1)) and (element_0[counter_0] == element_1[counter_0])):
        ...
        print(f"    i_hello_1 . element_0 = ''{element_0}'' . element_0[counter_0] = ''{element_0[counter_0]}'' .")    
...
def finder_1(element_0, list_0):
    ...
    while (counter_0 < len(list_0)):
        ...
        print(f"i_hello_1 . list_0[counter_0] = {list_0[counter_0]} . ")
        
        
        counter_1 = 0
        
        
        while (counter_1 < list_0[counter_0][1]):
            
            
            if (finder_0(element_0=element_0, element_1=list_0[counter_0][1][counter_1]) > 0):
            
                print(f"i_hello_0 .")    
                 
                content_0 += upload_the_content(list_0, counter_1)
