...
that should contain 'False' to stop the program .
...
type_of_encoding_0 = r"""___type_of_encoding_0___"""


type_of_encoding_1 = r"""___type_of_encoding_1___"""


type_of_encoding_2 = r"""___type_of_encoding_2___"""
...
def main():
    ...
    while (run_0 == True):
        ...
        if (os.path.exists(file_2) == True):
            ...
            message_0 = "this file should contain 'False' to stop the program ."
        ...
        if (continue_ == "True"):
            ...
            while (len(list_of_element) > 0):
            
                list_of_element.pop(0)
