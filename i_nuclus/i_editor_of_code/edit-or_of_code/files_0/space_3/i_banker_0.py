                ...
                if (v_0[counter_0][:4] == " " * (4 * 1)):
                    ...
                    while ((run_0 == True) and (counter_0 < len(v_0))):
                        ...
                        if (v_0[counter_0] != ""):
                            ...
                            print(f"i_hello_1 . counter_0 = {counter_0} . v_0[counter_0][:(4 * 2) + 1] = {v_0[counter_0][:(4 * 2) + 1]} .")
                            
                            if (v_0[counter_0][:(4 * 2) + 1] == " " * (4 * 2)):
                                
                                
                                
                                                                
                                if (v_0[counter_0][(4 * 2) + 1:(4 * 2) + len("pocket") + 1] == "pocket"):
...
def create_new_account_of_amount(name_of_file_of_the_bank, identificater, name_of_unity):
...
def main():
    ...
    try:
        ...
        create_personal_account(name_of_file_of_the_bank=file_0, identificater="0", name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")
