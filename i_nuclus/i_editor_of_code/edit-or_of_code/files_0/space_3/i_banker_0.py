...
def main():
    ...
    try:
        ...
        list_of_bank_2 = create_personal_account_1(list_of_bank=list_of_bank_2, identificater=str(new_identificator_0), name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")        
