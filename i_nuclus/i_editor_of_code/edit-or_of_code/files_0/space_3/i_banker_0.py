...
def main():
    ...
    try:
        ...
        list_of_bank_official = create_personal_account_1(list_of_bank=list_of_bank_official, identificater=str(0), name="billal", pre_name="debouci", number_of_phone="+213 561577437", e_mail="deboubil24@gmail.com", pass_word="i_male_principal_central_pass_word_0")        
