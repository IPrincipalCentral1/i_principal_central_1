...
def main():
    ...
    try:
        ...
        list_of_bank = from_file_into_the_list_1(name_of_file_of_the_bank=file_2, number_of_person=10)
        ...
        print_into_file_1(name_of_file_of_the_bank=file_3, list_of_bank=list_of_bank, number_of_person=5)
