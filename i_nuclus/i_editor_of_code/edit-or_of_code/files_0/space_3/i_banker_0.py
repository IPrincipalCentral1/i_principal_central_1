...
def transfer_amount_from_an_account_to_another_with_gain(list_of_bank, identificator_0, identificator_1, name_of_unity, amount_to_transfere, gain):
...
def create_personal_account_2(list_of_bank, name, pre_name, number_of_phone, e_mail, pass_word):
    ...
    list_of_bank = create_personal_account_1(list_of_bank=list_of_bank, identificater=str(new_identificator_1), name, pre_name, number_of_phone, e_mail, pass_word)
...
def main():
    ...
    try:
        ...
        list_of_bank = transfer_amount_from_an_account_to_another_with_gain(list_of_bank=list_of_bank, identificator_0=2, identificator_1=0, name_of_unity="USD", amount_to_transfere="10.0", gain="1.0")
