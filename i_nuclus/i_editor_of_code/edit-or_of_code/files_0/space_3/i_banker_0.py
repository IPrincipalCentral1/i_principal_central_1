...
class i_banker():
    ...
    def create_personal_account(self, name_of_file_of_the_bank, identificater, name, pre_name, number_of_phone, e_mail, pass_word):
    ...
    def create_personal_account_1(self, list_of_bank, identificater, name, pre_name, number_of_phone, e_mail, pass_word):
    ...
    def create_personal_account_2(self, list_of_bank, name, pre_name, number_of_phone, e_mail, pass_word):
        ...
        list_of_bank = self.create_personal_account_1(list_of_bank=list_of_bank, identificater=str(new_identificator_1), name=name, pre_name=pre_name, number_of_phone=number_of_phone, e_mail=e_mail, pass_word=pass_word)
    ...
    def print_my_official_account(self):
        ...
        list_of_bank_official = self.create_personal_account_1(list_of_bank=list_of_bank_official, identificater="0", name="billal", pre_name="debouci", number_of_phone="+213 561577437", e_mail="deboubil24@gmail.com", pass_word="i_male_principal_central_pass_word_0")        
...
def main():
    ...
    try:
        ...
        object_of_banker.create_personal_account(name_of_file_of_the_bank=file_0, identificater="2", name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")
        ...
        list_of_bank = object_of_banker.create_personal_account_1(list_of_bank=list_of_bank, identificater=str(new_identificator_0), name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")
        ...
        list_of_bank_2 = object_of_banker.create_personal_account_1(list_of_bank=list_of_bank_2, identificater=str(new_identificator_1), name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")        
