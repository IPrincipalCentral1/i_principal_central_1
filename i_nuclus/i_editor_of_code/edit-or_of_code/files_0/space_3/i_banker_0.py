...
def main():
    ...
    try:
        ...
        create_personal_account(name_of_file_of_the_bank=file_0, identificater="1", name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")
