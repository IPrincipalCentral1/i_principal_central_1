            ...
            if (counter_2 < len(list_of_bank)):
                ...
                if (counter_3 < len(list_of_bank[counter_2][-1])):
                    ...
                    if (m[0] == False):
                        ...
                        bool_0 = my_superieur_s_n_1(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point)
                        
                        bool_1 = my_egale_s_n_1(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point)
