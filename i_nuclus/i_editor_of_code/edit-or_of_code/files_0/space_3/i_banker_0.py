...
class i_banker():
    ...
    def print_my_official_account(self, file_of_bank_official, list_of_unity, identificator, name, pre_name, number_of_phone, e_mail, pass_word):
        ...
        big_amount = make_big_number(length_of_number=1_000)
