...
def from_file_into_the_list(name_of_file_of_the_bank, number_of_person):
...
def main():
    ...
    try:
        ...
        list_of_bank = from_file_into_the_list(name_of_file_of_the_bank=name_of_file_of_the_bank, number_of_person=10)
