...
def main():
    ...
    try:
        ...
        #affect_amount_to_the_account_with_a_specific_unity(list_of_bank=list_of_bank, identificator="0", name_of_unity=f"{unity_0}", amount="100.0")
        ...
        #affect_amount_to_the_account_with_a_specific_unity(list_of_bank=list_of_bank, identificator="0", name_of_unity=f"the quality of [{unity_0}]", amount="100.0")
