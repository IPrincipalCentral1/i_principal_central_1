...
def from_file_into_the_list_1(name_of_file_of_the_bank, number_of_person):
        ...
        while ((counter_0 < len(v_0)) and (run_2 == True)):
            ...
            if (v_0[counter_0] != ""):
                ...
                if (v_0[counter_0][:4] == " " * (4 * 1)):
                    ...
                    list_of_result.append([str_identificater])
...
def print_into_file_1(name_of_file_of_the_bank, list_of_bank, number_of_person):
...
def create_personal_account_1(list_of_bank, identificater, name, pre_name, number_of_phone, e_mail, pass_word):
    ...
    list_of_bank.append([identificater, name, pre_name, number_of_phone, e_mail, pass_word, []])
...
def add_amount_to_the_account_with_a_specific_unity(list_of_bank, identificator, name_of_unity, amount_to_add):
...
def transfer_amount_from_an_account_to_another_with_gain(list_of_bank, identificator_0, identificator_1, identificator_gainer_0, name_of_unity, amount_to_transfere, gain):
...
def generate_new_identificator(list_of_bank):
...
def create_personal_account_2(list_of_bank, name, pre_name, number_of_phone, e_mail, pass_word):

            
    new_identificator_1 = generate_new_identificator(list_of_bank=list_of_bank)
    
    list_of_bank = create_personal_account_1(list_of_bank=list_of_bank, identificater=str(new_identificator_1), name=name, pre_name=pre_name, number_of_phone=number_of_phone, e_mail=e_mail, pass_word=pass_word)
...
def from_list_of_file_into_the_list(list_of_name_of_file_of_the_bank):
    ...
    while (counter_0 < len(list_of_name_of_file_of_the_bank)):
        ...
        element = from_file_into_the_list(name_of_file_of_the_bank=list_of_name_of_file_of_the_bank[counter_0])
        
        if (len(element) > 0):
            
            
            list_of_result.extend(from_file_into_the_list(name_of_file_of_the_bank=list_of_name_of_file_of_the_bank[counter_0]))
...
def print_my_official_account():
    ...
    list_of_bank_official = create_personal_account_1(list_of_bank=list_of_bank_official, identificater="0", name="billal", pre_name="debouci", number_of_phone="+213 561577437", e_mail="deboubil24@gmail.com", pass_word="i_male_principal_central_pass_word_0")        
    ...
    while (counter_0 < len(list_of_unity)):
        ...
        list_of_bank_official = create_new_account_of_amount(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"[{unity_0}]")
                
        affect_amount_to_the_account_with_a_specific_unity(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"[{unity_0}]", amount=big_amount)
        
        
        list_of_bank_official = create_new_account_of_amount(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"the quality of [{unity_0}]")
                
        affect_amount_to_the_account_with_a_specific_unity(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"the quality of [{unity_0}]", amount=big_amount)
        
        
                    
        
        list_of_bank_official = create_new_account_of_amount(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"[{unity_0}]-s")
                
        affect_amount_to_the_account_with_a_specific_unity(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"[{unity_0}]-s", amount=big_amount)
        
        
        list_of_bank_official = create_new_account_of_amount(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"the quality of [{unity_0}]-s")
                
        affect_amount_to_the_account_with_a_specific_unity(list_of_bank=list_of_bank_official, identificator="0", name_of_unity=f"the quality of [{unity_0}]-s", amount=big_amount)
    ...
    print_into_file(name_of_file_of_the_bank=file_bank_official_1, list_of_bank=list_of_bank_official)
...
def main():
    ...
    try:
        ...
        list_of_bank = from_list_of_file_into_the_list(list_of_name_of_file_of_the_bank=[file_0])
        ...
        list_of_bank = create_new_account_of_amount(list_of_bank=list_of_bank, identificator="0", name_of_unity="USD")
        ...
        list_of_bank = transfer_amount_from_an_account_to_another_with_gain(list_of_bank=list_of_bank, identificator_0="2", identificator_1="0", identificator_gainer_0="2", name_of_unity="USD", amount_to_transfere="10.0", gain="1.0")
        ...
        list_of_bank_1 = from_file_into_the_list_1(name_of_file_of_the_bank=file_2, number_of_person=10)
        
        
        new_identificator_0 = generate_new_identificator(list_of_bank=list_of_bank)
        
        print(f"new_identificator_0 = {new_identificator_0} .")
        
        
        list_of_bank = create_personal_account_1(list_of_bank=list_of_bank, identificater=str(new_identificator_0), name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")
        
        
                
        file_3 = os.path.join(cwd, "bank_3.the_bank")
        
        print_into_file(name_of_file_of_the_bank=file_3, list_of_bank=list_of_bank)
        ...
        list_of_bank_2 = from_file_into_the_list(name_of_file_of_the_bank=file_4)
        
                
        new_identificator_1 = generate_new_identificator(list_of_bank=list_of_bank_2)
        
        print(f"new_identificator_1 = {new_identificator_1} .")
        

        list_of_bank_2 = create_personal_account_1(list_of_bank=list_of_bank_2, identificater=str(new_identificator_1), name="billal", pre_name="debouci", number_of_phone="+213 123456789", e_mail="e_mil_0@e_mail.com", pass_word="i_male_principal_central_pass_word_0")        
        
        
        print_into_file(name_of_file_of_the_bank=file_4, list_of_bank=list_of_bank_2)
