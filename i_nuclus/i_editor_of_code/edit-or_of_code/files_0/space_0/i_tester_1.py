...
list_0 = ['EUR', 'EUR', 'EUR', 'EUR', 'BDT', 'EUR', 'EUR', 'JPY', 'EUR']



result_1 = transform_and_calculate_0(list_0=list_0, amount=amount)
...
list_0 = ['EUR', 'BDT', 'EUR', 'EUR', 'JPY', 'EUR']
