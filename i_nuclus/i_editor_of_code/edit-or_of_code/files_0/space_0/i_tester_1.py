...
def wait_for_the_next_step_0():
    ...
    with open(file_0, "r") as f_:
        ...
        content = f_.read(oa.path.getsize(file_0))
...
#while (run_0 == True):
    ...
    #while ((counter_0 < len(list_of_result_1))):

        #if (list_of_result_1[counter_0] != ""):

            #if ((counter_0 < len(list_of_result_0)) and (list_of_result_0[counter_0] == list_of_result_1[counter_0])):
    ...
    #if (counter_0 == len(list_of_result_0)):
