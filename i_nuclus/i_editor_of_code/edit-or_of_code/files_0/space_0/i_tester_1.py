...
def extract_and_calculate_0(list_of_result):
    ...
    while (counter_0 < len(list_of_result)):
        ...
        list_of_unity.append(wise_supported_currencies[int(list_of_result[counter_0])])
...
while (counter_2 < 10):
    ...
    while (run_0 == True):
        ...
        if (list_of_result_0[-1] != "0"):
        
            counter_0 = 0
            
            while (counter_0 < len(list_of_result_0) + 1):
    ...
    print(f"\n\n 0 . list_of_result_0 = {list_of_result_0} .\n\n\n")
    
    
    
    extract_and_calculate_0(list_of_result=list_of_result_0)
...
list_of_result_1 = reader_of_possibility_0()



print(f"\n\n 0 . list_of_result_1 = {list_of_result_1} .\n\n\n")




extract_and_calculate_0(list_of_result=list_of_result_1)
