...
paypal_supported_currencies = [
                            ...
                            "RUB", "USD", "EUR", "AUD", "BRL", "CAD", "CNY", "CZK", 

                            "HUF", "INR", "ILS", "JPY", "MYR", "MXN", "TWD", "NZD",

                            "NOK", "PHP", "PLN", "GBP", "SGD", "SEK", "CHF",
...
supported_currencies = paypal_supported_currencies
...
file_0 = os.path.join(os.getcwd(), "currency_paypal_1.csv")
...
while (counter_2 <= 100_000):
    ...
    #while ((counter_0 < len(result[1]))):
        ...
        #if ((result[1][counter_0] == "USD")):

            #if ((counter_0 - 1 > 0) and (result[1][counter_0 - 1] == "USD")):
    ...
    #if ((result[0][1] > max_0[0]) and (counter_1 >= 2) and (counter_0 == len(result[1]))):
