...
paypal_supported_currencies_1 = [
                            ...
                            "SYP", "IQD", "KWD", "LBP", "MRU", "ARS", "BRL", "CAD", "MXN", "CUP", "KPW", "KRW", "IRR", "AFN", "TRY",        
                            
                            "BYN", "BZD", "XOF", "BTN", "BOB", "BAM", "BWP", "BND", "BGN", "BIF", "CVE", "KHR", "XAF", "DZD",
                            
                            "CLP", "CNY", "COP", "KMF", "CRC", "HRK", "CZK", "DKK", "DJF", "DOP", "USD", "ERN", "AOA", "ALL",
                            
                            "SZL", "ETB", "FJD", "GMD", "GEL", "GHS", "GTQ", "GNF", "GYD", "HTG", "HNL", "HUF", "ISK", "INR",
                            
                            "IDR", "ILS", "JMD", "JPY", "JOD", "KZT", "KES", "KGS", "LAK", "AZN", "BSD", "BHD", "XCD", "EGP",
                            
                            "LSL", "LRD", "LYD", "MOP", "MKD", "MKD", "MGA", "MWK", "MYR", "MVR", "MUR", "EUR", "AMD", "AUD",
                            
                            "MDL", "MNT", "MAD", "MZN", "MMK", "NAD", "NPR", "ANG", "NZD", "NIO", "NGN", "NOK", "OMR", "PKR",
                            
                            "PAB", "PGK", "PYG", "PEN", "PHP", "PLN", "QAR", "RON", "RUB", "RWF", "SHP", "WST", "STN", "SAR",
                            
                            "RSD", "SCR", "SLL", "SGD", "SBD", "SOS", "ZAR", "SSP", "LKR", "SDG", "SRD", "SEK", "CHF", 
