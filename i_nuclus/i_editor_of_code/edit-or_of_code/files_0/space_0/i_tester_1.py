...
paypal_supported_currencies_1 = [
                            ...
                            "ILS", "LYD", "ZAR", "INR", "CNY", "EUR", "USD", "TWD", "SAR", "AFN", "ALL", "DZD", "AOA", "XCD", "ARS", 
                            
                            "BYN", "BZD", "XOF", "BTN", "BOB", "BAM", "BWP", "BRL", "BND", "BGN", "BIF", "CVE", "LAK",
                            
                            "CAD", "CLP", "COP", "KMF", "CRC", "HRK", "CUP", "CZK", "DKK", "DJF", "DOP", "ERN", "MXN",
                            
                            "SZL", "ETB", "FJD", "GMD", "GEL", "GHS", "GTQ", "GNF", "GYD", "HTG", "HNL", "HUF", "ISK", 
                            
                            "IDR", "IRR", "IQD", "JMD", "JPY", "JOD", "KZT", "KES", "KPW", "KRW", "KWD", "KGS", "GBP",
                            
                            "LBP", "LSL", "LRD", "MOP", "MKD", "MKD", "MGA", "MWK", "MYR", "MVR", "MRU", "MUR", 
                            
                            "MDL", "MNT", "MAD", "MZN", "MMK", "NAD", "NPR", "ANG", "NZD", "NIO", "NGN", "NOK", "OMR", 
                            
                            "PAB", "PGK", "PYG", "PEN", "PHP", "PLN", "QAR", "RON", "RUB", "RWF", "SHP", "WST", "STN", 
                            
                            "RSD", "SCR", "SLL", "SGD", "SBD", "SOS", "SSP", "LKR", "SDG", "SRD", "SEK", "CHF", "SYP",
                            
                            "TJS", "TZS", "THB", "TOP", "TTD", "TND", "TRY", "TMT", "UGX", "UAH", "AED", "UYU", "UZS",
                            
                            "VUV", "VES", "VND", "YER", "ZMW", "ZWL", "FKP", "GIP", "IMP", "JEP", "KID", "SML", "TVD",
                            
                            "BDT", "BBD", "AMD", "AUD", "AZN", "BSD", "BHD", "KHR", "XAF", "PKR",
...
supported_currencies = [
        ...
        "eat machwi", "drink water", "go to bed", "produce machwi",
...
file_0 = os.path.join(os.getcwd(), "currency_paypal_4.csv")
...
list_of_result = [
            ...
            ['eat machwi', 3, 'go to bed'] ,
        
            ['eat machwi', 4, 'produce machwi'] ,
        
            ['eat machwi', 5, 'produce water'] ,
        
            ['eat machwi', 6, 'produce bed'] ,
        
            ['drink water', 0.5, 'eat machwi'] ,
        
            ['drink water', 1, 'drink water'] ,
        
            ['drink water', 2, 'go to bed'] ,
        
            ['drink water', 3, 'produce machwi'] ,
        
            ['drink water', 4, 'produce water'] ,
        
            ['drink water', 5, 'produce bed'] ,
        
            ['go to bed', 0.3333333333333333, 'eat machwi'] ,
        
            ['go to bed', 0.5, 'drink water'] ,
        
            ['go to bed', 1, 'go to bed'] ,
        
            ['go to bed', 2, 'produce machwi'] ,
        
            ['go to bed', 3, 'produce water'] ,
        
            ['go to bed', 4, 'produce bed'] ,
        
            ['produce machwi', 0.25, 'eat machwi'] ,
        
            ['produce machwi', 0.3333333333333333, 'drink water'] ,
        
            ['produce machwi', 0.5, 'go to bed'] ,
            ...
            ['produce water', 0.2, 'eat machwi'] ,
        
            ['produce water', 0.25, 'drink water'] ,
        
            ['produce water', 0.3333333333333333, 'go to bed'] ,
            ...
            ['produce bed', 0.16666666666666666, 'eat machwi'] ,
        
            ['produce bed', 0.2, 'drink water'] ,
        
            ['produce bed', 0.25, 'go to bed'] ,
