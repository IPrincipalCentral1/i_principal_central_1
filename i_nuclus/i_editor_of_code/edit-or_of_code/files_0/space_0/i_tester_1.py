...
while (counter_2 <= number_of_calculation):
    ...
    print(f"\n\n    i_hello_0_i . counter_2 = {counter_2} . list_of_result_0 = {list_of_result_0} .\n\n\n")



    result = extract_and_calculate_0(list_of_result=list_of_result_0, amount=amount)

    print(f"i_hello_1_i . result = {result} .")
    ...
    if ((result[0][1] > max_0[0])):
        ...
        #while ((i_counter_3_i < len(result[1])) and ()):
