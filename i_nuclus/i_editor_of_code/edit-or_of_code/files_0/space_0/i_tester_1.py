...
def extract_and_calculate_0(list_of_result, amount):
    ...
    while (counter_0 < len(list_of_result)):
        ...
        list_of_unity.append(paypal_supported_currencies[int(list_of_result[counter_0])])
...
file_0 = os.path.join(os.getcwd(), "currency_paypal_0.csv")
...
if ((len(sys.argv) > 1)):
    ...
    content = content.replace("___postion_of_max_range___", str(len(paypal_supported_currencies) - 1))
