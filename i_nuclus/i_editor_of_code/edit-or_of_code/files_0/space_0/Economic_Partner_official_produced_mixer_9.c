...
int main()
{
    ...
    strcpy(i_string_5, "this file should contain just 'true' for the mixer to affect the step");
    
    strcpy(i_string_6, "i_mix_of_mixer_2.i_mixer");
    ...
    while (run == true)
    {
        ...
        if (char_equal_(i_string_0, i_string_2) == true)
        {
            ...
            printf("\n\n i_hello . remove_ele_list_of_Accounts_of_Amount . \n\n");

            
            while (len_list_of_Accounts_of_Amount(i_head_amount) > 0)
            {
            
            
                remove_ele_list_of_Accounts_of_Amount(&i_head_amount, 0);
