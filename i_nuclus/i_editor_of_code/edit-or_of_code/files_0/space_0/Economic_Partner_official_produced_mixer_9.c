...
int main()
{
    ...
    char *i_string_1 = malloc(200), *i_string_2 = malloc(200), *i_string_4 = malloc(200), *name_of_folder = malloc(100), *i_string_5 = malloc(200), *i_string_6 = malloc(200), *i_string_7 = malloc(200);
    ...
    strcpy(i_string_7, i_name_of_unity_of_encoding);
    ...
    char *i_string_3 = malloc(10000 + 1), *i_string_0 = malloc(1000);
    ...
    while (run == true)
    {
        ...
        if (char_equal_(i_string_0, i_string_2) == true)
        {
            ...
            add_ele_list_of_Accounts_of_Amount(&i_head_amount, u, i_n_2, len_list_of_Accounts_of_Amount(i_head_amount));
