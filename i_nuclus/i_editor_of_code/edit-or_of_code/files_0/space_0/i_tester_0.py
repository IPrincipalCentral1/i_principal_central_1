...
def next_step_0():
    ...
    #file_1 = os.path.join(os.getcwd(), "maker_of_next_step_0.c")
...
list_of_result = reader_of_possibility_0()


print(f"\n\n 0 . list_of_result = {list_of_result} .\n\n\n")
...
print(f"\n\n 1 . list_of_result = {list_of_result} .\n\n\n")
