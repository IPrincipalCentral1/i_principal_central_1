...
there is 1 condition :
    ...
    it mean from the amount that you where having wich is 5.0 . you will have 13.573 after transforming like that :
    ...
    at the end you will have 13.573 DZD .

    and you can repeat all the process but this time with 13.573 DZD .
...
while (counter_0 < 20):
    ...
    print(f"counter_0 = {counter_0} . q = {q} {list_0[0]} . time = {(counter_0 + 1) * (len(list_0) - 1)} . m = {m} .")
