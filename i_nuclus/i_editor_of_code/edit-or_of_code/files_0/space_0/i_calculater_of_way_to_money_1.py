...
#m = i_math_0.calculatrice_2(s=oper, l_=[], n=0, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point, e=False)
...
this is the same as i_calculater_of_way_to_money_0.py but it use my math : i_math_0.py
...
while (counter_2 <= number_of_calcule):
    ...
    bool_0 = i_math_0.my_superieur_s_n_1(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point)
...
print(f"\n\n if you keep doing that this is what will happen from {amount} {list_0[0]} : \n\n")
...
while (counter_0 < 20):
    ...
    print(f"counter_0 = {counter_0} . q = {q} {list_0[0]} . time = {(counter_0 + 1) * (len(list_0) - 1)} .")
