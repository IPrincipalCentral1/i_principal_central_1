...
def i_main_0_i(argv_1):    
    ...
    i_length_of_the_numbers_0_i = (( ( i_macro_of_maximum_length_of_the_content_of_the_files_1_i + number_of_digit_after_the_floating_point ) // ( 10 ** i_v_0_i ) ) + 2)
    
    
    print(f"i_length_of_the_numbers_0_i = {i_length_of_the_numbers_0_i} . \n i_macro_of_maximum_length_of_the_content_of_the_files_1_i + number_of_digit_after_the_floating_point = {i_macro_of_maximum_length_of_the_content_of_the_files_1_i + number_of_digit_after_the_floating_point} .")
