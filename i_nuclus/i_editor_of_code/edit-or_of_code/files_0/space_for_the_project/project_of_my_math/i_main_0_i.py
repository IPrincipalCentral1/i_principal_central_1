...
# this is the langth of chunk in each the number . 
...
i_macro_of_length_of_char_pointer_0_i = 1000000


i_macro_of_length_of_char_pointer_1_i = 1000000
...
def i_main_0_i(argv_1):
    ...
    content = content.replace("_____i_macro_of_length_of_char_pointer_0_i_____", f"{i_macro_of_length_of_char_pointer_0_i}")
    
    
    
    content = content.replace("_____i_macro_of_length_of_char_pointer_1_i_____", f"{i_macro_of_length_of_char_pointer_1_i}")
