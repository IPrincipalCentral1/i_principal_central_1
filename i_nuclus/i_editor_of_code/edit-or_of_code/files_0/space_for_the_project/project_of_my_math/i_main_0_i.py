...
i_macro_of_maximum_length_of_the_name_of_the_files_0_i = 1000000


i_macro_of_maximum_length_of_the_content_of_the_files_1_i = 1000000
...
def i_main_0_i(argv_1):
    ...
    with open(i_file_of_a_0_i, "r") as f_:
        ...
        i_length_of_the_numbers_0_i += len(f_.read(os.path.getsize(i_file_of_a_0_i)))
    ...
    with open(i_file_of_b_0_i, "r") as f_:
        ...
        i_length_of_the_numbers_0_i += len(f_.read(os.path.getsize(i_file_of_b_0_i)))
        
        
    
    
    i_length_of_the_numbers_0_i *= 3
    ...
    content = content.replace("_____i_macro_of_length_of_char_pointer_0_i_____", f"{i_macro_of_maximum_length_of_the_name_of_the_files_0_i}")
