...
void i_mult_int_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    struct number i_v_number_0_i[(*i_b_0_i).length_of_num];
    ...
    while (0 <= i_counter_1_i)
    {
        ...
        i_reformater_of_number_0_i(&i_v_number_0_i[i_counter_1_i], i_b_0_i);
        ...
        while (0 <= i_counter_0_i)
        {
            ...
            (i_v_number_0_i[i_counter_1_i]).num[i_counter_0_i] = i_v_mult_1_i;
        ...
        printf("\n i_v_number_0_i[%ld]", i_counter_1_i);
        
        print_number(" = ", &i_v_number_0_i[i_counter_1_i]);
...
void i_mult_number_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    i_reformater_of_number_0_i(&i_n_2_i, i_b_0_i);
