...
void i_div_number_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    while (ints_superieur_equal(&i_v_1_i, i_a_0_i) == false)
    {
        ...
        //add_number(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_3_i, &i_v_0_i, &i_save_number_0_i);
...
int main()
{
    ...
    char *i_string_0_i = malloc(10000);
    
    str_number(&i_string_0_i, &n3);
