...
void i_div_number_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    i_n_number_1_0_i.signe = i_signe_0_i;
...
int main()
{
    ...
    n1.num[i_macro_of_Number_max_of_word_byte - 2] =  100;
    ...
    n2.num[i_macro_of_Number_max_of_word_byte - 2] =  2;
