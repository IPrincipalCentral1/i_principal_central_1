...
int main()
{
    ...
    *i_content_of_operator_0_i = malloc(i_macro_of_length_of_char_pointer_1_i), *i_content_of_result_0_i = malloc(i_macro_of_length_of_char_pointer_1_i);
    ...
    number_str(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_a_0_i, i_content_of_a_0_i);
    
    
    number_str(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_b_0_i, i_content_of_b_0_i);
