...
void i_reformater_of_number_0_i(struct number *i_result_0_i, struct number *i_number_0_i)
{
    ...
    int64_t i_q_0_i = 1, i_q_1_i = 1, i_counter_1_i, i_limit_0_i = i_Number_of_digits_max / 2;
    ...
    while (0 < i_counter_0_i)
    {
        ...
        (*i_result_0_i).num[i_counter_0_i] = (*i_number_0_i).num[i_counter_0_i] % i_q_0_i;
        
        
        (*i_result_0_i).num[i_counter_0_i - 1] = ((*i_number_0_i).num[i_counter_0_i] / i_q_0_i);
