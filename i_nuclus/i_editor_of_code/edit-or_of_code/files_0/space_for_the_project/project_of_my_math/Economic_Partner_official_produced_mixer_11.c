...
#define i_macro_of_length_of_char_pointer_0_i 1000000


#define i_macro_of_length_of_char_pointer_1_i _____i_macro_of_length_of_char_pointer_1_i_____
...
void str_number_1(char *result, struct number *n)
{
    ...
    if ((*n).length_of_num > 0)
    {
        ...
        else
        {
            ...
            if ((all_s[k] == '0') && (len - k > (*n).number_of_digite_maximum_after_the_floating_point))
            {
                
                while ((all_s[k] == '0') && (len - k > (*n).number_of_digite_maximum_after_the_floating_point))
                {
                ...
                if ((len - k <= (*n).number_of_digite_maximum_after_the_floating_point))
                {
...
void number_str(int64_t number_of_digite_maximum_after_the_floating_point, struct number *n, char *s)
{
    ...
    while (n->length_of_num < i_macro_of_Number_max_of_word_byte)
    {
...
void number_str_1(int64_t number_of_digite_maximum_after_the_floating_point, struct number *n, char *s)
{
    ...
    int64_t i_counter_1_i = i_macro_of_Number_max_of_word_byte - 1;
    ...
    int64_t i_counter_0_i = i_macro_of_Number_max_of_word_byte - 1;
...
void i_shift_to_right_0_i(struct number *i_n_0_i, int64_t i_number_of_shift_0_i)
{
    
    
    int64_t i_counter_0_i = 0;
    
    int64_t i_reminder_0_i = 0, i_v_n_0_i, i_q_0_i;
    ...
    while (i_counter_0_i < i_Number_of_digits_max - 1)
    {
    ...
    while (i_counter_0_i < i_number_of_shift_0_i)
    {
        
        
        int64_t i_counter_1_i = 0;
        
        
        while (i_counter_1_i < (*i_n_0_i).length_of_num)
        {
            
            
            i_v_n_0_i = i_reminder_0_i;
            
            i_reminder_0_i = (*i_n_0_i).num[i_counter_1_i] % 10;
            
            (*i_n_0_i).num[i_counter_1_i] /= 10;
            
            (*i_n_0_i).num[i_counter_1_i] += i_v_n_0_i * i_q_0_i;
...
void i_shift_to_left_0_i(struct number *i_n_0_i, int64_t i_number_of_shift_0_i)
{
    ...
    while (i_counter_0_i < i_number_of_shift_0_i)
    {
        ...
        int64_t i_counter_1_i = (*i_n_0_i).length_of_num - 1;
        ...
        while (0 <= i_counter_1_i)
        {
            ...
            i_reminder_0_i = (*i_n_0_i).num[i_counter_1_i] / i_q_0_i;
            
            
            
            
            (*i_n_0_i).num[i_counter_1_i] = (*i_n_0_i).num[i_counter_1_i] % i_q_0_i;
            
            (*i_n_0_i).num[i_counter_1_i] *= 10;
            
            (*i_n_0_i).num[i_counter_1_i] += i_v_n_0_i;
...
void i_mult_int_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    i_shift_to_right_0_i(i_result_0_i, (*i_result_0_i).number_of_digite_maximum_after_the_floating_point);
...
void i_div_number_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    while (ints_superieur_equal(&i_v_1_i, i_a_0_i) == false)
    {
        ...
        while (ints_superieur_equal(&i_v_1_i, i_a_0_i) == false)
        {
            ...
            //print_number("i_n_number_10_0_i = ", &i_n_number_10_0_i);
            
            
            
            
            
            i_shift_to_left_0_i(&i_incr_0_i, 1);
    ...
    //i_shift_to_left_0_i(&i_v_0_i, i_v_0_i.number_of_digite_maximum_after_the_floating_point);
...
void read_ing_in_file(char *i_string_0, char *file_path)
{
    ...
    else
    {
        ...
        char i_word[i_macro_of_length_of_char_pointer_1_i];
...
void read_ing_in_file_1(char *i_string_0, char *file_path)
{
    ...
    strcat(i_cwd, "/i_space_of_calcul_0_i/");
    
    
    strcat(i_cwd, file_path);
...
int main()
{
    ...
    char *i_name_of_file_a_0_i = malloc(i_macro_of_length_of_char_pointer_0_i), *i_name_of_file_b_1_i = malloc(i_macro_of_length_of_char_pointer_0_i),
    
    *i_name_of_file_operator_2_i = malloc(i_macro_of_length_of_char_pointer_0_i), *i_name_of_file_result_3_i = malloc(i_macro_of_length_of_char_pointer_0_i);
    
    
    char *i_content_of_a_0_i = malloc(i_macro_of_length_of_char_pointer_1_i), *i_content_of_b_0_i = malloc(i_macro_of_length_of_char_pointer_1_i),
    
    *i_content_of_operator_0_i = malloc(i_macro_of_length_of_char_pointer_1_i), *i_content_of_result_0_i = malloc(i_macro_of_length_of_char_pointer_1_i);
    
    
    
    strcpy(i_name_of_file_a_0_i, "i_file_of_a_0_i.txt");
    
    strcpy(i_name_of_file_b_1_i, "i_file_of_b_0_i.txt");
    
    strcpy(i_name_of_file_operator_2_i, "i_file_of_operator_0_i.txt");
    
    strcpy(i_name_of_file_result_3_i, "i_file_of_result_0_i.txt");
    ...
    read_ing_in_file_1(i_content_of_a_0_i, i_name_of_file_a_0_i);
    
    
    read_ing_in_file_1(i_content_of_b_0_i, i_name_of_file_b_1_i);
    
    
    read_ing_in_file_1(i_content_of_operator_0_i, i_name_of_file_operator_2_i);
    
    
    
    
    bool i_semaphore_of_division_by_zero = false, i_semaphore_of_result_0_i, i_semaphore_of_change_0_i = false;
    
    
    
    struct number i_v_a_0_i, i_v_b_0_i, i_v_result_0_i, i_v_number_0__0_i, i_v_a_1_i, i_v_b_1_i;
    
    
    
    
    
    initialize_number(&i_v_a_1_i);
    
    
    initialize_number(&i_v_b_1_i);
    
    
    
    
    initialize_number(&i_v_a_0_i);
    
    
    initialize_number(&i_v_b_0_i);
    
    
    initialize_number(&i_v_result_0_i);
    
    
    initialize_number(&i_v_number_0__0_i);
    
    
    
    
    
    number_str_1(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_a_0_i, i_content_of_a_0_i);
    
    
    number_str_1(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_b_0_i, i_content_of_b_0_i);
    
    
    
    number_str(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_a_1_i, i_content_of_a_0_i);
    
    
    number_str(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_b_1_i, i_content_of_b_0_i);
    
    
    print_number("i_v_a_1_i = ", &i_v_a_1_i);
    
    
    print_number("i_v_b_1_i = ", &i_v_b_1_i);
    ...
    printf("\n i_content_of_a_0_i = \"%s\" . i_content_of_b_0_i = \"%s\" . i_content_of_operator_0_i = \"%s\" .\n\n", i_content_of_a_0_i, i_content_of_b_0_i, i_content_of_operator_0_i);
    
    
    
    print_number("i_v_a_0_i = ", &i_v_a_0_i);
    
    
    print_number("i_v_b_0_i = ", &i_v_b_0_i);
    
    
    
    if (char_equal_(i_content_of_operator_0_i, "+") == true)
    {
        
    
        add_number(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_result_0_i, &i_v_a_0_i, &i_v_b_0_i);
        
        
        
    }
    else if (char_equal_(i_content_of_operator_0_i, "-") == true)
    {
        
        
        sub_number(i_macro_of_number_of_digite_maximum_after_the_floating_point, &i_v_result_0_i, &i_v_a_0_i, &i_v_b_0_i);
    ...
    else if (char_equal_(i_content_of_operator_0_i, "*") == true)
    {
        ...
        i_mult_number_0_i(&i_v_result_0_i, &i_v_a_0_i, &i_v_b_0_i);
    ...
    else if (char_equal_(i_content_of_operator_0_i, "/") == true)
    {
        ...
        if (int_equal(&i_v_b_0_i, &i_v_number_0__0_i) == false)
        {
        
            
            i_div_number_0_i(&i_v_result_0_i, &i_v_a_0_i, &i_v_b_0_i);
        ...
        else
        {
            ...
            i_semaphore_of_division_by_zero = true;
    ...
    else if (char_equal_(i_content_of_operator_0_i, ">=") == true)
    {
        ...
        i_semaphore_of_change_0_i = true;
        
        
        
        if (ints_superieur_equal(&i_v_a_0_i, &i_v_b_0_i) == true)
        {
    ...
    else if (char_equal_(i_content_of_operator_0_i, "==") == true)
    {
        ...
        if (int_equal(&i_v_a_0_i, &i_v_b_0_i) == true)
        {
    ...
    print_number("i_v_result_0_i = ", &i_v_result_0_i);
    
    
    
    
    
    if (i_semaphore_of_division_by_zero == false)
    {
        
        str_number_1(i_content_of_result_0_i, &i_v_result_0_i);
        
    }
    else
    {
        
        i_content_of_result_0_i = malloc(1000);
        
        
        strcpy(i_content_of_result_0_i, "    error : division by 0    ");
    ...
    if (i_semaphore_of_change_0_i == true)
    {
        
        
        i_content_of_result_0_i = malloc(1000);
        
        if (i_semaphore_of_result_0_i == true)
        {
            
            
            strcpy(i_content_of_result_0_i, "true");
        ...
        else
        {
            ...
            strcpy(i_content_of_result_0_i, "false");
    ...
    printf("\n\n i_content_of_result_0_i = \"%s\" \n\n", i_content_of_result_0_i);
    
    
    
    printf("\n\n %s %s %s = %s \n\n", i_content_of_a_0_i, i_content_of_operator_0_i, i_content_of_b_0_i, i_content_of_result_0_i);
    ...
    strcat(i_cwd, i_name_of_file_result_3_i);
    ...
    save_ing_in_file(i_content_of_result_0_i, i_cwd);
