...
void i_mult_int_0_i(struct number *i_result_0_i, struct number *i_a_0_i, struct number *i_b_0_i)
{
    ...
    int64_t i_counter_0_i, i_counter_1_i, i_reminder_0_i, i_v_mult_0_i, i_v_mult_1_i, i_q_0_i, 
    ...
    while (0 <= i_counter_1_i)
    {
        ...
        while (0 <= i_counter_0_i)
        {
            ...
            printf("\n    i_hello_1_i . (i_v_number_0_i[%ld]).num[%ld] = %ld . i_reminder_0_i = %ld . (*i_a_0_i).num[%ld] = %ld . (*i_b_0_i).num[%ld] = %ld . i_v_mult_1_i = %ld .\n", i_counter_1_i, i_counter_0_i, (i_v_number_0_i[i_counter_1_i]).num[i_counter_0_i], i_reminder_0_i, i_counter_0_i, (*i_a_0_i).num[i_counter_0_i], i_counter_1_i, (*i_b_0_i).num[i_counter_1_i], i_v_mult_1_i);
