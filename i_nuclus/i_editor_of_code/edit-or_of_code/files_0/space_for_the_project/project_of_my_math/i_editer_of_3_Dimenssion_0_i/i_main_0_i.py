...
print(f"A_s = {A_s:.3e} m^2, A_b = {A_b:.3e} m^2, k={k}")
print(f"M_eff = {M_eff:.5f} kg, K = {K:.5f} N/m, Fg = {Fg:.5f} N, damping c = {c:.5f} N s/m")
