...
try:
    ...
    class Window(QMainWindow):
        ...
        def __init__(self):
            ...
            self.search_font_size = 12
            
            self.size_bar_of_search_0 = 300
            
            self.search_bar_size = (int(self.size_bar_of_search_0), int(self.size_bar_of_search_0 // (self.i_golden_number_0 * 10)))
            ...
            self.search_bar.textChanged.connect(self.filter_grid)
        ...
        def show_grid(self):
            ...
            while (i_counter_i_0 < 100):
                ...
                items.append((f"title {i_counter_i_0}", "description number {i_counter_i_0}", f"button {i_counter_i_0}"))
