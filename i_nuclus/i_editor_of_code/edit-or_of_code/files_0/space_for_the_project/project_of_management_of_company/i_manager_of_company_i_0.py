...
try:
    ...
    class Window(QMainWindow):
        ...
        def __init__(self):
            ...
            button1.setFixedSize(size_of_button[0], size_of_button[1])
            ...
            button2.setFixedSize(size_of_button[0], size_of_button[1])
            
            
            button3 = QPushButton("i_background_i_0")
            
            button3.setFixedSize(size_of_button[0], size_of_button[1])
