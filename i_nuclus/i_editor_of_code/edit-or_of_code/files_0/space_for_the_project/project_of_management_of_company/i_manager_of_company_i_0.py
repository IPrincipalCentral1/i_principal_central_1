...
try:
    ...
    class Window(QMainWindow):
        ...
        def __init__(self):
            ...
            ## Layout عمودي لوضع القائمة بالأعلى والأزرار بالأسفل

            #v_layout = QVBoxLayout(central)

            ## هنا نضيف الـ scroll area (القائمة) فوق

            #v_layout.addWidget(self.scroll)

            ## Stretch علشان يخلي الأزرار تنزل للأسفل
            ...
            #self.main_layout.addWidget(self.i_button_of_index_i_0)

            ## ScrollArea حتى القائمة تكون قابلة للتمرير
