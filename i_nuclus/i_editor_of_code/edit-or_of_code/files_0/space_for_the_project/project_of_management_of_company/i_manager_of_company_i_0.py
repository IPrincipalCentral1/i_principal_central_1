...
try:
    ...
    class Window(QMainWindow):
        ...
        def __init__(self):
            ...
            self.i_golden_number_0 = 0.6180339887
            ...
            self.size_of_button_of_ground[1] = int(self.size_of_button_of_ground[0] // i_golden_number_0)
            ...
            self.i_file_of_icon_i_0 = os.path.join(cwd, i_folder_i_1, "icon_of_index_i_0.png")
            
            
            self.i_creation_of_button_of_ground_0(i_button_i_0=button1, i_image_i_0=self.i_file_of_icon_i_0, i_size_of_button_i_0=self.size_of_button_of_ground)
            
            
            #button1.setFixedSize(self.size_of_button_of_ground[0], self.size_of_button_of_ground[1])
            ...
            self.i_file_of_icon_i_1 = os.path.join(cwd, i_folder_i_1, "i_icon_of_work_i_0.png")
            
            self.i_creation_of_button_of_ground_0(i_button_i_0=button2, i_image_i_0=self.i_file_of_icon_i_1, i_size_of_button_i_0=self.size_of_button_of_ground)
            
            
            
            #button2.setFixedSize(self.size_of_button_of_ground[0], self.size_of_button_of_ground[1])
            ...
            self.i_file_of_icon_i_2 = os.path.join(cwd, i_folder_i_1, "i_icon_of_background_i_0.png")
            
            self.i_creation_of_button_of_ground_0(i_button_i_0=button2, i_image_i_0=self.i_file_of_icon_i_2, i_size_of_button_i_0=self.size_of_button_of_ground)
            
            
            #button3.setFixedSize(self.size_of_button_of_ground[0], self.size_of_button_of_ground[1])
