...
try:
    ...
    class Window(QMainWindow):
        ...
        def __init__(self):
            ...
            #self.font_size_description = 10

            #self.font_size_button = 12

            #self.button_size = (120, 50)
            ...
            # --- أزرار تحت ---
            size_of_button_of_ground = [120, int(120 // self.i_golden_number_0)]
            
            size_of_button_of_ground[1] = size_of_button_of_ground[0] // self.i_golden_number_0
            
            
            self.i_button_of_index_i_0 = self.i_creation_of_button_of_ground_i_0("", self.i_file_of_icon_i_0, size_of_button_of_ground, self.show_grid)
            self.i_button_of_index_i_1 = self.i_creation_of_button_of_ground_i_0("", self.i_file_of_icon_i_1, size_of_button_of_ground, self.i_function_of_i_button_of_index_i_1)
            self.i_button_of_index_i_2 = self.i_creation_of_button_of_ground_i_0("", self.i_file_of_icon_i_2, size_of_button_of_ground, self.toggle_background)
            self.i_button_of_index_i_3 = self.i_creation_of_button_of_ground_i_0("", self.i_file_of_icon_i_3, size_of_button_of_ground, self.cycle_theme)
