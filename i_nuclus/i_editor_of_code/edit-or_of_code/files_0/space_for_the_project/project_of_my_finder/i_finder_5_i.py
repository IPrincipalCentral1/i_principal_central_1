...
this program will give you the element on the number of the list .

it means give the element_n with all his content .
...
you can use the functions from i_reformater_0_i.py :
...
type_of_encoding_1 = "_____type_of_encoding_1____"


type_of_encoding_2 = "_____type_of_encoding_2____"


type_of_encoding_3 = "_____type_of_encoding_3____"
...
def main():
    ...
    try:
        ...
        if (os.path.exists(file_of_content_to_search_0) == True):
            ...
            message = "this file should have the number on the list that you want to search on . if it '-1' it will display all content ."
    ...
    def finder_1(element_0, list_0):
        ...
        try:
            ...
            if (i_index_0_i >= 0):
                ...
                i_content_of_result_0_i += upload_the_content(list_0, i_index_0_i)
                ...
                while (i_counter_0_i < len(list_0)):
                    
                    
                    
                    i_content_of_result_0_i += upload_the_content(list_0, i_counter_0_i)    
        ...
        return [i_content_of_result_0_i, i_index_0_i]
        ...
        while (run_0 == True):
            ...
            if (continue_ == "True"):
                ...
                while (counter_5 < len(list_of_element)):
                    ...
                    i_list_1_i = finder_1(element_0=content_2, list_0=list_of_element[counter_5])
                    
                    
                    content_0 += i_list_1_i[0]
