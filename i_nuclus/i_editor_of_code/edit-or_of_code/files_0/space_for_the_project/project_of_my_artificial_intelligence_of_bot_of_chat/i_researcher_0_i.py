...
def search_wikipedia(i_query_0_i, i_lenguage_0_i, i_url_0_i):
        ...
        with sync_playwright() as p:
            ...
            if (len(i_v_0_i) > 1):
                ...
                while (i_counter_0_i < len(i_v_0_i) - 1):
                    ...
                    i_url_0_i += f"{i_v_0_i[i_counter_0_i]}{i_lenguage_0_i}"
                    
                    i_counter_0_i += 1
                    
                
                
                i_url_0_i += f"{i_v_0_i[i_counter_0_i]}"
                
            
            i_v_0_i = i_url_0_i.split("{i_query_0_i}")
            ...
            if (len(i_v_0_i) > 1):
                ...
                while (i_counter_0_i < len(i_v_0_i) - 1):
                    ...
                    i_url_0_i += f"{i_v_0_i[i_counter_0_i]}{i_query_0_i}"
...
if __name__ == "__main__":
    ...
    i_text_of_result_0_i = search_wikipedia(i_query_0_i="Python (programming \n language)", i_lenguage_0_i="en", i_url_0_i=i_link_0_i)
