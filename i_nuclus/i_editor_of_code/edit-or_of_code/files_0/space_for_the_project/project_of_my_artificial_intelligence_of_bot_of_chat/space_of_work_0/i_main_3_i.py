...
i_file_0_i = os.path.join(cwd, "i_file_of_all_character_possible_with_chr_in_python_0_i.txt")
...
with open(i_file_0_i, "w") as f_:
    ...
    while (i_counter_1_i < 2_000_000):
        ...
        print(f"i_hello_1_i . i_counter_1_i = {i_counter_1_i} . i_counter_2_i = {i_counter_2_i} .")
