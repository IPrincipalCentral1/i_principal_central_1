...
def main():
    ...
    i_counter_1 = get_similarity_0(phrase_0=text_0, phrase_1=text_1, separater_of_words=separater_of_words, not_counted_words=not_counted_words, number_of_digit_after_the_floating_point=number_of_digit_after_the_floating_point)
