...
def finder_2_1(element_0, element_1):
    ...
    if (len(element_0) > 0):
        ...
        while (i_counter_3 < len(element_1)):
            ...
            while (i_counter_4 < len(element_0)):
                ...
                while ((i_counter_5 < len(element_0[i_counter_4])) and (i_counter_3 + i_counter_5 < len(element_1)) and (element_0[i_counter_5] == element_1[i_counter_3 + i_counter_5])):
                ...
                if (i_max_0 == len(element_0[i_counter_4])):
...
def main():
    ...
    i_v_2 = finder_2_1(element_0=["aa"], element_1=text)
