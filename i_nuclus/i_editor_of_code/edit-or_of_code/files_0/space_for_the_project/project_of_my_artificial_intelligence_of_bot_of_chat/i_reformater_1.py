...
def main():
    ...
    with open(i_path_of_input_0_i, "r", encoding="utf-8") as f_:
        
        i_content_0_i = f_.read(os.path.getsize(i_path_of_input_0_i))
        
        
    
    
    i_v_1_i = i_extract_sentences_from_html_0_i(i_text_of_input_0_i=i_content_0_i)
    ...
    def describe_char(c):
        ...
        return f"{c} : {unicodedata.name(c, 'UNKNOWN')}"
    ...
    for code in range(0x110000):
        ...
        try:
            ...
            print(describe_char(i_char_0_i))
