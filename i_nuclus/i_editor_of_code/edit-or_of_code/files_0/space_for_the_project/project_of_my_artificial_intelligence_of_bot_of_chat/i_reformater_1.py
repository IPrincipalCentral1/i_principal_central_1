...
def extract_list_1(text, separater_of_words, not_counted_words):
    ...
    list_result_0 = i_get_the_occerency_of_all_word_1(list_1=text)
...
def main():
    ...
    i_v_7 = extract_list_1(text="i_hello_0 . i_hello_1 .", separater_of_words=separater_of_words, not_counted_words=not_counted_words)
