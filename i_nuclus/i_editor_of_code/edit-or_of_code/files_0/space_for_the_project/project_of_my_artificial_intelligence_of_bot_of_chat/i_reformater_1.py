...
def i_get_list_of_individual_amount_0_i(i_list_result_1_i, i_list_result_2_i):
    ...
    if (len(i_list_result_1_i) > 0):
        ...
        while (i_counter_2_i < len(i_list_of_result_0_i)):
            ...
            i_list_of_result_0_i[i_counter_2_i] = sort_element_0_0(l=i_list_of_result_0_i[i_counter_2_i])
...
def extract_list_2(text, separater_of_words, not_counted_words):
    ...
    i_result_0_i = i_get_list_of_individual_amount_0_i(i_list_result_1_i=i_list_result_0_i[0], i_list_result_2_i=i_v_0_i[1])
    
    
    print(f"\n\n    i_result_0_i = {i_result_0_i} .\n\n")
    
    
    
    i_result_1_i = i_get_list_of_individual_amount_1_i(i_list_of_result_0_i=i_result_0_i)
    
    
    
    print(f"\n\n    i_result_1_i = {i_result_1_i} .\n\n")
    
    
    return i_list_result_0_i[1]
