...
def get_similarity_0(phrase_0, phrase_1, separater_of_words, not_counted_words):
...
def main():
    ...
    i_counter_1 = get_similarity_0(phrase_0=text_0, phrase_1=text_1, separater_of_words=separater_of_words, not_counted_words=not_counted_words)
