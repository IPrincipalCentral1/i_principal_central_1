...
def i_builder_of_dictionary_0():
    ...
    list_of_all_word_0_0 = list_of_all_word_0[:50]
    
    
        
    list_of_all_word_0_0 = sort_element_1_1(l=list_of_all_word_0_0)
    
    
    print(f"عدد الكلمات: {len(list_of_all_word_0_0)}")
    
    print(list(list_of_all_word_0_0)) 
