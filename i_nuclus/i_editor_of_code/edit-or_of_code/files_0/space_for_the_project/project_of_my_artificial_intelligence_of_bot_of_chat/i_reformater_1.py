...
def i_get_list_of_individual_amount_0_i(i_list_result_1_i):
    ...
    if (len(i_list_result_1_i) > 0):
        ...
        i_counter_1_i = i_list_result_1_i[0][0]
...
def extract_list_2(text, separater_of_words, not_counted_words):
    ...
    i_result_0_i = i_get_list_of_individual_amount_0_i(i_list_result_1_i=i_list_result_0_i[0])
