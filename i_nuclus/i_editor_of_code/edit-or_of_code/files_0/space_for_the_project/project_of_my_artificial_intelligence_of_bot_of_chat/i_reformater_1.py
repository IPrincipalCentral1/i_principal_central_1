...
def sort_element_1_1(l):
    ...
    while (0 < len(l)):
        ...
        t1 = i_calculat_and_display_in_the_loop_0(first_time=t1, amount_of_time_0=2.0, var_0=["len(l_) = ", len(l_), " . len(l) = ", len(l), " . pourcent = ", pourcent_0])
...
def i_builder_of_dictionary_0():
    ...
    # تحميل بيانات wordnet (مرة واحدة فقط)
    ...
    # كل الكلمات (lemmas) الموجودة في WordNet
    ...
    for synset in wn.all_synsets():
        ...
        for lemma in synset.lemmas():
            ...
            list_of_all_word_0.append(lemma.name())
            
    
    
        
    list_of_all_word_0 = sort_element_1_1(l=list_of_all_word_0)
    
    
    print(f"عدد الكلمات: {len(list_of_all_word_0)}")
    
    print(list(list_of_all_word_0)[:50])  # مثال: أول 50 كلمة
