...
def get_the_golden_number_0(number_of_suit_0, number_of_digit_after_the_floating_point):
    ...
    while (i_counter_0 < number_of_suit_0):
        ...
        print(f"u_0 = {u_0} . u_1 = {u_1} . i_counter_1 = {i_counter_1} .")
        ...
        print(f"i_counter_2 = \"{i_counter_2}\" .")
...
def main():
    ...
    i_v_4 = get_the_golden_number_0(number_of_suit_0=30, number_of_digit_after_the_floating_point=20)
