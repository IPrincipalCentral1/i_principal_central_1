...
def get_the_golden_number_0(number_of_digit_after_the_floating_point):
    ...
    # return [ the_golden_number , the_number_of_calcule_to_get_there , 2 - the_golden_number, 1 / the_golden_number, (1 - ( 1 / the_golden_number))] 
    
    
    return [i_counter_2, i_counter_0, i_counter_4, i_counter_5, i_counter_6]
