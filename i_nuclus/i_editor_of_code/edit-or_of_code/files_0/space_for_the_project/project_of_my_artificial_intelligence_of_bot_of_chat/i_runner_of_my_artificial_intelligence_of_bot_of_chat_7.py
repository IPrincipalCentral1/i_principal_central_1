...
def main():
    ...
    content_of_i_calculater_of_way_to_money_2 = content_of_i_calculater_of_way_to_money_2.replace("_____number_of_calcule_minimum_____", number_of_calcule_minimum)
