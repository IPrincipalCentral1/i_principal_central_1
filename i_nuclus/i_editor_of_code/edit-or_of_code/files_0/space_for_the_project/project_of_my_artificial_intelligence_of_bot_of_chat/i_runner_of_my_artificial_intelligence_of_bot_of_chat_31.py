...
this one bring all words possible from the text of input .
...
the_language_to_translate_to = "_____the_language_to_translate_to____"
...
list_to_organize_0 = i_reformater_1.extract_list_1(text=text, separater_of_words=separater_of_words, not_counted_words=not_counted_words)
...
file_of_i_calculater_of_way_to_money_3 = os.path.join(cwd, "i_calculater_of_way_to_money_3.py")


file_of_i_calculater_of_way_to_money_3_0 = os.path.join(cwd, "i_calculater_of_way_to_money_3_0.py")





file_of_i_organize_official_2 = os.path.join(cwd, "i_organize_official_2.py")


file_of_i_organize_official_2_0 = os.path.join(cwd, "i_organize_official_2_0.py")
...
def main():
    ...
    content_of_i_organize_official_2 = ""
    
    
    i_d_0_i = Path(file_of_i_organize_official_2)
    
    
    content_of_i_organize_official_2 = i_d_0_i.read_text()
    
    

    #with open(file_of_i_organize_official_2, "r", encoding=encoding_0) as f_:


        #content_of_i_organize_official_2 = f_.read(os.path.getsize(file_of_i_organize_official_2))


        
    
    
    content_of_i_organize_official_2 = content_of_i_organize_official_2.replace("_____number_of_digit_after_the_floating_point_____", str(number_of_digit_after_the_floating_point))
    
    
    
    content_of_i_organize_official_2 = content_of_i_organize_official_2.replace("_____porcent_of_gain_____", porcent_of_gain)
    
    
    
    content_of_i_organize_official_2 = content_of_i_organize_official_2.replace("_____list_to_organize_____", str(list_to_organize_0))
    
    
    
    i_d_0_i = Path(file_of_i_organize_official_2_0)
    
    
    i_d_0_i.write_text(content_of_i_organize_official_2)
    
    


    #with open(file_of_i_organize_official_2_0, "w", encoding=encoding_0) as f_:


        #f_.write(content_of_i_organize_official_2)
    ...
    import i_organize_official_2_0
    
    
    importlib.reload(i_organize_official_2_0)
    
    
    string_of_list_organized = i_organize_official_2_0.main()
    ...
    content_of_i_calculater_of_way_to_money_3 = ""
    
    
    i_d_0_i = Path(file_of_i_calculater_of_way_to_money_3)
    
    
    content_of_i_calculater_of_way_to_money_3 = i_d_0_i.read_text()
    
    



    #with open(file_of_i_calculater_of_way_to_money_3, "r", encoding=encoding_0) as f_:

        #content_of_i_calculater_of_way_to_money_3 = f_.read(os.path.getsize(file_of_i_calculater_of_way_to_money_3))
    ...
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____i_maximum_time_0_i_____", f"{i_maximum_time_2_i}")
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____number_of_calcule_____", number_of_calcule_minimum)
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____supported_currencies_____", str(list_to_organize_0))
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____list_of_result_____", string_of_list_organized)
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____number_of_digit_after_the_floating_point_____", str(number_of_digit_after_the_floating_point))
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("___number_of_chunk_0___", number_of_chunk_0)
    
    
        
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____latest_type_of_int_____", latest_type_of_int)
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____the_length_of_1_complete_number_of_your_int_____", f"{the_length_of_1_complete_number_of_your_int}")
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____minimum_value_1_____", minimum_value_0)
    
    
    
    content_of_i_calculater_of_way_to_money_3 = content_of_i_calculater_of_way_to_money_3.replace("_____type_of_encoding_0_____", encoding_0)
    ...
    i_d_0_i = Path(file_of_i_calculater_of_way_to_money_3_0)
    
    
    i_d_0_i.write_text(content_of_i_calculater_of_way_to_money_3)
    


    #with open(file_of_i_calculater_of_way_to_money_3_0, "w", encoding=encoding_0) as f_:


        #f_.write(content_of_i_calculater_of_way_to_money_3)
    ...
    import i_calculater_of_way_to_money_3_0
    
    
    importlib.reload(i_calculater_of_way_to_money_3_0)
    
    
    
    max_1 = i_calculater_of_way_to_money_3_0.main(argv_1=_____init_____)
    ...
    i_string_result_with_all_word_possible_0_i = transform_from_list_to_string_2(list_0=i_list_result_with_all_word_possible_0_i)
    ...
    print(f"i_hello_0_i . i_counter_0_i = {i_counter_0_i} . i_string_result_with_all_word_possible_0_i = \"{i_string_result_with_all_word_possible_0_i}\" .")
