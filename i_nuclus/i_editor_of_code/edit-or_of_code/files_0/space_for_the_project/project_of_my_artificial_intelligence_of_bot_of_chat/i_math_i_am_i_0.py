...
if (i["i am i"] == True):
    ...
    if __name__ == "__main__":
        ...
        print(f"{i_greater_1_i(s1, s2, number_of_digit_after_the_floating_point_)}")
        ...
        print(s1, ">", s2, " = ", i_greater_1_i(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point))
        
        print(s1, "<", s2, " = ", i_inferior_1_i(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point))
        
        print(s1, "==", s2, " = ", i_equal_1_i(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point))
