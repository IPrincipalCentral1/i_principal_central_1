...
if (i["i am i"] == True):
    ...
    def i_check_0_i(i_result_0_i):
        ...
        while ((i_counter_0_i < len(i_result_0_i)) and (i_result_0_i[i_counter_0_i] in ("0", "1", "2", "2", "4", "5", "6", "7", "8", "9", 
    ...
    if __name__ == "__main__":
        ...
        m = calculatrice_3(s=i_operation_0_i, l_=[], n=0, number_of_digit_after_the_floating_point_=10, e=False)
        
        t2 = time.time()
        
        print("i_operation_0_i = '", i_operation_0_i, "' . m = ", m, " . number_of_digit_after_the_floating_point_ = ", number_of_digit_after_the_floating_point, " . time = ", t2 - t1)
