...
def main():
    ...
    content_of_i_calculater_of_way_to_money_5 = content_of_i_calculater_of_way_to_money_5.replace("_____number_of_element_minus_1_____", len(list_to_organize_0) - 1)
