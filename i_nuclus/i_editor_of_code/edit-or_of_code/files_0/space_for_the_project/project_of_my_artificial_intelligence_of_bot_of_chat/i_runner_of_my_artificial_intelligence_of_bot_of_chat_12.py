...
def main():
    ...
    with open(file_of_i_calculater_of_way_to_money_2, "r", encoding="utf-8") as f_:
    ...
    with open(file_of_i_calculater_of_way_to_money_2_0, "w", encoding="utf-8") as f_:
    ...
    i_list_0_i = [2, 3, 4, 5, 6]
    
    print(f"i_hello_1_i . __ = {i_list_0_i[1:]}")
