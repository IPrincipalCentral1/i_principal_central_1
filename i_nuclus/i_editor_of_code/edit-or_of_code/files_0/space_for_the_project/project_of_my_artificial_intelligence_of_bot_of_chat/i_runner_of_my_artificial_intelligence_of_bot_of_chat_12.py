...
def main():
    ...
    i_list_of_list_of_word_0_i = max_1[1][-2:]
    ...
    print(f"i_hello_0_i . i_counter_0_i = {i_counter_0_i} . i_list_to_organize_1_i = {i_list_to_organize_1_i} .")
    ...
    return [max_1, i_content_0, i_content_1, i_list_to_organize_1_i]
