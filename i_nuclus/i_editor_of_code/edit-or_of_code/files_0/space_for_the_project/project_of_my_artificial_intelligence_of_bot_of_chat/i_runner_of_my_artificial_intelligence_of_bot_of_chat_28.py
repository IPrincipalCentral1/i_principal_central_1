...
how can i describ each thing of this (problem or simulation) flowing this syntax :
...
and than impliment it into the input of the artificial intelligence of principal central like that :
...
the_description_of_the__problem_or_simulation
