...
هاذا برنامج يضع مقياس بين عملات لكن يستعمل i_math_i_am_i_0 انه جيد . و يعمل معه .
...
This is a program that creates a scale between currencies, and it uses i_math_i_am_i_0. It's good and works with it.
        ...
        while (counter_1 < len(list_to_organize)):
            ...
            if (counter_3 >= len(organized_list_0)):
                ...
                if (counter_4 >= len(organized_list_1)):
                    ...
                    bool_1 = i_math_i_am_i_0.my_inferieur_s_n_1(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point)
                    ...
                    m = i_math_i_am_i_0.calculatrice_3(s=operation, l_=[], n=0, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point, e=False)
