...
def i_main_0_i():
    ...
    while (i_counter_i_0 < i_number_of_cycle_i_0):
        ...
        if (i_add_generater_of_phrase_0_i == True):
            ...
            with open(i_file_of_artificial_intelligence_7_i_0, "r", encoding=type_of_encoding_0) as f_:
            ...
            i_content_of_artificial_intelligence_7_i_0 = i_content_of_artificial_intelligence_7_i_0.replace("_____i_maximum_time_2_i_____", f"{i_maximum_time_2_i}")
            ...
            with open(i_file_of_artificial_intelligence_7_0_i_0, "w", encoding=type_of_encoding_0) as f_:
