...
def i_main_0_i():
    ...
    i_list_of_all_result_0_i = []
    
    
    i_list_of_all_result_1_i = []
    ...
    while (i_counter_i_0 < i_number_of_cycle_i_0):
        ...
        if (i_add_generater_of_phrase_0_i == True):
            ...
            if ((len(i_list_of_all_result_0_i) == 0) or ((len(i_list_of_all_result_0_i) > 0) and (i_v_i_0[1] != i_list_of_all_result_0_i[-1]))):
                
                
                i_add_into_file_i_0(i_v_i_0=i_v_i_0)
                
                
                i_list_of_all_result_0_i.append(i_v_i_0[1])
        ...
        if (i_add_generater_of_word_0_i == True):
            ...
            if ((len(i_list_of_all_result_1_i) == 0) or ((len(i_list_of_all_result_1_i) > 0) and (i_v_i_0[1] != i_list_of_all_result_1_i[-1]))):
            
                
                i_add_into_file_i_1(i_v_i_0=i_v_i_0)
                
                
                i_list_of_all_result_1_i.append(i_v_i_0[1])
