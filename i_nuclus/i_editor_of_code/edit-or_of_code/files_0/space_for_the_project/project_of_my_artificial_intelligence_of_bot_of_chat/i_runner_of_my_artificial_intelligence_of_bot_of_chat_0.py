...
number_of_chunk_0 = str(int(( len(list_to_organize_0) // (10 ** 18) ) + 1))
...
with open(file_of_i_calculater_of_way_to_money_1, "r", encoding="utf-8") as f_:
    ...
    content_of_i_calculater_of_way_to_money_1 = f_.read(os.path.join(file_of_i_calculater_of_way_to_money_1))
...
content_of_i_calculater_of_way_to_money_1 = content_of_i_calculater_of_way_to_money_1.replace("_____number_of_calcule_____", str(number_of_calcule))
