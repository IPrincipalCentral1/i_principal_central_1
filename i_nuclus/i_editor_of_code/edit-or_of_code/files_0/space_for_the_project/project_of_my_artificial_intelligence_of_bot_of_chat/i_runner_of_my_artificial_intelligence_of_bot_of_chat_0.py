...
def main():
    ...
    content = content.replace("_____latest_type_of_int_____", latest_type_of_int)
    
    
    
    content = content.replace("_____the_length_of_1_complete_number_of_your_int_____", f"{the_length_of_1_complete_number_of_your_int}")
