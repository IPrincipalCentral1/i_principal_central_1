...
i_semaphore_of_counting_the_separaters_0_i = _____i_semaphore_of_counting_the_separaters_0_i_____
...
i_semaphore_of_get_the_maximum_mix_0_i = _____i_semaphore_of_get_the_maximum_mix_0_i_____
...
if (i_semaphore_of_counting_the_separaters_0_i == False):
    ...
    list_to_organize_0 = i_reformater_1.extract_list_5(text=text, separater_of_words=separater_of_words, not_counted_words=not_counted_words)
...
def main():
    ...
    content_of_i_calculater_of_way_to_money_8 = content_of_i_calculater_of_way_to_money_8.replace("_____i_semaphore_of_get_the_maximum_mix_0__i_____", str(i_semaphore_of_get_the_maximum_mix_0_i))
