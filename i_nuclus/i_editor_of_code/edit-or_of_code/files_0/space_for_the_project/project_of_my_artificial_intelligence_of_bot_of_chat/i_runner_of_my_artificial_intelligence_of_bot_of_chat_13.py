...
def main():
    ...
    # return [ max_1 , content , all_content_combine , i_string_result_with_all_word_possible_0_i ]
    
    
    return [max_1, i_content_0, i_content_1, i_string_result_with_all_word_possible_0_i]
