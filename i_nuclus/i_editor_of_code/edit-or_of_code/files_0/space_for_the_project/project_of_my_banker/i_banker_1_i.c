...
int main()
{
    ...
    int64_t i_counter_0_i = 0, i_counter_1_i = 10;
    
    int64_t i_counter_2_i = i_counter_1_i / 10;
    ...
    char *i_string_0_i = malloc(10000 + 1), *i_string_1_i = malloc(i_number_0_i  + 1),
    
    *i_string_2_i = malloc(i_macro_of_length_of_text_0_i + 1);
