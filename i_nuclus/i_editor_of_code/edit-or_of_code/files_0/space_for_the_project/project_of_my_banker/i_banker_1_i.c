...
int main()
{
    ...
    *i_string_2_i = malloc(i_counter_2_i + 1);
    ...
    else
    {
        ...
        char *i_p_0_i, i_p_1_i;
        
        
        i_p_0_i = stpcpy(i_string_1_i, "");
        
        
        int64_t i_counter_3_i = 1000;
        ...
        while (i_counter_0_i < i_counter_3_i)
        {
            
            i_p_0_i = stpcpy(i_p_0_i, "0");
        ...
        while (i_counter_0_i < i_counter_2_i)
        {
            ...
            //strcat(i_string_2_i, i_string_1_i);
            
            i_p_1_i = stpcpy(i_p_1_i, i_string_1_i);
            
            
            
            i_counter_0_i += i_counter_3_i;
