...
if (i["i am i"] == True):
    ...
    def my_superieur_s_n_1(s1, s2, number_of_digit_after_the_floating_point_):
        ...
        return i_greater_1_i(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point_)


    def my_inferieur_s_n_1(s1, s2, number_of_digit_after_the_floating_point_):

        return i_inferior_1_i(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point_)
    ...
    def my_egale_s_n_1(s1, s2, number_of_digit_after_the_floating_point_):
        ...
        return i_equal_1_i(s1=s1, s2=s2, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point_)
