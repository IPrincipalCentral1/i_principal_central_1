...
class i_banker():
    ...
    def function_of_my_work_1(self):    
        ...
        while (i_counter_0_i < len(self.list_of_unity_0) - 1):
            
            i_element_0_i = {}
            
            i_element_0_i["name_of_unity"] = self.list_of_unity_0[i_counter_0_i]
            ...
            print(f"{i_c_0_i} \"name_of_unity\" : \"{self.list_of_unity_0[i_counter_0_i]}\" {i_c_1_i} , \n\n")
            
            i_content_0_i += f"    {i_c_0_i} \"name_of_unity\" : \"{self.list_of_unity_0[i_counter_0_i]}\" {i_c_1_i} , \n    \n    \n"
        ...
        if (i_counter_0_i < len(self.list_of_unity_0)):
        ...
        while (i_counter_2 <= len(self.list_of_unity_0)):
            ...
            while ((counter_0 < len(self.list_of_unity_0)) and (counter_0 < i_counter_2)):
                
                list_of_unity_1.append(self.list_of_unity_0[counter_0])
