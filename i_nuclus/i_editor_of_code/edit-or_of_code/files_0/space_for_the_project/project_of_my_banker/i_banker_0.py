...
class i_banker():
    ...
    def function_of_my_work_1(self):    
        ...
        self.print_official_account_1(file_of_bank_official=file_0, list_of_unity=list_of_unity_1, length_of_number_0=length_of_number_1, identificator=identificator_1, name=name_0, pre_name=pre_name_0, number_of_phone=number_of_phone_0, e_mail=e_mail_0, pass_word=pass_word_0)
    ...
    def print_official_account_1(self, file_of_bank_official, list_of_unity, length_of_number_0, identificator, name, pre_name, number_of_phone, e_mail, pass_word):
        ...
        big_amount = self.make_big_number(length_of_number=length_of_number_0)
