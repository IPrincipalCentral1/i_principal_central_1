...
or we can use a list of dimenssion . like :
    ...
    i_list_of_dimenssions_0_i[0] for spliting 1 dimenssion ( like in a text linear ) 
    
    
    i_list_of_dimenssions_0_i[1] for spliting 2 dimenssion ( like in an image 2 dimensional ) 
    
    
    i_list_of_dimenssions_0_i[3] for spliting 3 dimenssion
...
so like that :
    ...
    [" i_list_of_dimenssions_0_i "]
    
    
and initialize like that :
    
    
    i_list_of_dimenssions_0_i = [0] # for 1 dimension 
    
    
    i_list_of_dimenssions_0_i = [0, 0] # for 2 dimension 
    
    
    i_list_of_dimenssions_0_i = [0, 0, 0] # for 3 dimension 
