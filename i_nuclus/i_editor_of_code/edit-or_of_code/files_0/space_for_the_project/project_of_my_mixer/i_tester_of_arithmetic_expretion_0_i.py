...
we can make even more languages . like that :
    ...
    
    {
        ...
        languages_{number_of_languages}
        {
            
            "the_name_of_language_1" : {the_name_of_language} , 
            
            "extra_informations" : {extra_informations__in_the_extra_information_we_add_more_words_to_make_it_more_powerful} , 
            
            
            
            "the_name_of_language_2" : {the_name_of_language} , 
            ...
            "the_name_of_language_n" : {the_name_of_language} , 
...
i call this function that you can discus with :
    
    
    " artificial intelligance functional " 
...
we can reenforce this ai . by using it to make a new dictionary initial . to make it again to build a new function . i like to call that : second layer .


we can make 3 layers here . each one more descriptive then the other . to make sure that it is perfect :
...
lets stick with just 3 layers . and focus on making the computer better .
...
we can make a discution between AIs to acomplish a task .




we can do a discution between :
    
    
    your ai ( master or worker ) .
    
    
    this ai functional .
    
    
    and my_artificial_intelligance_of_bot_of_chat
    
    
    
    

and let them discus about do certene task ( well defined in a file that they can read ) .



and you can controle the power of the ai funtional ( i mean making it as much powerful as we can ) . by make more words generated  ( i_var_of_number_of_words_in_dictionary_0_i, i_var_of_number_of_words_init_dictionary_0_i ) .




and you can controle the power of my_artificial_intelligance_of_bot_of_chat . by chosing between using :
...
and how many cicles you will do with :
    
    
    ( generater_of_phrase == True ) or ( generater_of_words == True )
    
    
    


lets call that : i_discution_to_acomplish_a_task_3_i
