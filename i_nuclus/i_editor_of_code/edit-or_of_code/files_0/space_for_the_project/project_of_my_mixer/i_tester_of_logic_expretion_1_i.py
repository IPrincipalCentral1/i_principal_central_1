...
the algebric expretion use just :
    ...
    add ( your variables separatly . Ex : [" x1 ", " x2 ", ...] ) xor ( as list . Ex : i_list_0_i . that contain all the values of your variables . 
    
        and remember to declare the list like : i_list_0_i = ["value_1", "value_2", ...] ) .
