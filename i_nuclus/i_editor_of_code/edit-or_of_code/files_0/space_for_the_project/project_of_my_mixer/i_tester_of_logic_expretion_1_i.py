...
the algebric expretion use just :
    ...
    add the functions if you have ( do not put them in between 2 spaces ) . ( remeber to declare your function in i_init_of_variables_0_i if they are not declared ) . Example :
