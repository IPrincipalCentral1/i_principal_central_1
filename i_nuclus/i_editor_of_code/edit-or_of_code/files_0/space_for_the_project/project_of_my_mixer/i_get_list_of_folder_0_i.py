...
i_v_0_i = i_main_0_i()
        ...
        # section of executing the command 
        ...
        i_text_resulted_0_i = subprocess.run([f"{sys.executable}", f"{i_file_1_i}"], capture_output=True, text=True)
    ...
    return [i_var_of_error_compilation_0_i, i_list_of_result_0_i, i_text_resulted_0_i]
