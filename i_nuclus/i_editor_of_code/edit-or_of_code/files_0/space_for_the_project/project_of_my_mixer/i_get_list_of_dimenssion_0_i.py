...
def i_get_list_of_dimenssion_0_i():
    ...
    if (i_last_spliter_0_i - i_first_spliter_0_i == 0):
        ...
        i_list__0_i = i_get_list_of_dimenssion_1_i(i_list_0_i=[], i_separater_0_i=1)
        
        
        
        print(f"\n\ni_hello_4_i . _ = {i_list__0_i} .\n\n")
        ...
        i_list_4_i = [[i_list_0_i[0][0], i_list_0_i[0][1], 0, i_list_0_i]]
