...
def i_get_list_of_dimenssion_0_i():
    ...
    if (i_last_spliter_0_i - i_first_spliter_0_i == 0):
        ...
        while (i_first_spliter_0_i <= i_counter_0_i):
            ...
            print(f"i_hello_0_i . i_list_0_i[i_counter_1_i][0] = {i_list_0_i[i_counter_1_i][0]} . i_counter_0_i = {i_counter_0_i} .")
            
            i_list_1_i = i_get_list_of_dimenssion_1_i(i_list_0_i=i_list_0_i[i_counter_1_i][0], i_separater_0_i=i_counter_0_i)
