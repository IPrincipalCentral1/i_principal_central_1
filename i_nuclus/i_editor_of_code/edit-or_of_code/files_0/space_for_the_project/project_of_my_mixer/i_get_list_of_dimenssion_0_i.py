...
def i_get_list_of_dimenssion_0_i(i_list_0_i):
    ...
    i_list_of_all_contents_0_i = i_get_content_if_it_exist_0_i(i_list_of_all_steps_0_i=i_list_of_all_steps_0_i)
    
    
    
    
    
    return [i_list_from_the_mixer_0_i, i_list_of_possible_Sets_1_i, i_list_of_all_steps_0_i, i_last_spliter_0_i, i_list_of_all_contents_0_i]
