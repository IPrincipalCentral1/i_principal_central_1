...
def i_main_0_i():
    ...
    print(f"i_list_0_i = {i_list_0_i} . len_ = {len(i_list_0_i)} .")
    ...
    while (i_semaphore_of_continue_0_i == True):
        ...
        if (i_t_3_i - i_t_2_i >= 10.0):
        
            
            
            
            print(f"i_list_0_i = {i_list_0_i} . len(i_list_0_i) = {len(i_list_0_i)} .")
            
            
            print(f" i_number_of_operation_per_second_0_i = {i_number_of_operation_per_second_0_i} operation . i_max_0_i = {i_max_0_i} operation . i_min_0_i = {i_min_0_i} operation . i_number_of_general_0_i = {i_number_of_general_0_i} operation . len_1 = {len(str(i_number_of_general_0_i))}")
