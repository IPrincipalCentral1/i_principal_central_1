    ...
    def i_from_json_to_list_0_i(self, i_content_of_json_0_i):
        ...
        while (i_counter_0_i < len(i_content_of_json_0_i)):
            ...
            while ((i_counter_0_i < len(i_content_of_json_0_i) - 1)):
                ...
                elif ((((i_content_of_json_0_i[i_counter_0_i - 1] != "\\") and (i_content_of_json_0_i[i_counter_0_i] == "\"")))):
            ...
            while ((i_counter_0_i < len(i_content_of_json_0_i))):
                ...
                if ((i_counter_0_i < len(i_content_of_json_0_i) - 1) and (i_content_of_json_0_i[i_counter_0_i] == "\\") and (i_content_of_json_0_i[i_counter_0_i + 1] != "\"")):
