    ...
    def i_from_list_to_json_0_i(self, i_list_0_i):
        ...
        if (len(i_list_0_i) > 0):
            ...
            while (i_counter_0_i < len(i_list_0_i) - 1):
                ...
                i_content_0_i += "\\\"{i_list_0_i[i_counter_0_i][0]}\\\" : \\\"{i_list_0_i[i_counter_0_i][1]}\\\" , "
...
def i_main_0_i():
    ...
    i_content_1_i = i_from_list_to_json_0_i(i_list_0_i=[["ip", "127.0.0.1"], ["port", "5000"]]):
    
    
    i_class_0_i.i_create_router_0_i(i_identificator_0_i="0", i_name_0_i="i_router_0_i", i_detail_0_i=i_content_1_i)
    
    
    i_content_1_i = i_from_list_to_json_0_i(i_list_0_i=[["ip", "127.0.0.1"], ["port", "5001"]]):
