...
class _____name_of_class_0_____(i_main_of_library_0_i.i_class_0_i):
    ...
    def construct(self):
        ...
        # إنشاء المكعب
        cube = Cube(color=YELLOW, fill_opacity=0.3)
        self.add(cube)

        # قائمة النقاط التي ستمر منها الكاميرا
        list_of_points = [
            [0, 0, 4],
            [2, 1, 3],
            [1, 3, 2],
        ...
        self.i_move_the_camera_via_point_0_i(i_list_of_point_0_i=list_of_points)
