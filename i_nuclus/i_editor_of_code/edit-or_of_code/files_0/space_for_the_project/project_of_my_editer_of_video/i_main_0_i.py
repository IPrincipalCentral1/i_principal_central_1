...
class _____name_of_class_0_____(Scene):
    ...
    def construct(self):
        gravity = 9.8       # الجاذبية للأسفل
        damping = 0.995     # تخميد بسيط للحركة
        ...
        def update_double_pendulums(mob, dt):
            for i, pair in enumerate(mob):
                ...
                # معادلات البندول المزدوج (الجاذبية للأسفل)
