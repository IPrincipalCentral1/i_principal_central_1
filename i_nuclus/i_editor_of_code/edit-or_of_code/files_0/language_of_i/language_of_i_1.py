...
def print_conllu_info(sentences, file):
    ...
    #file = os.path.join(os.getcwd(), "space_0", "space_0", "information.txt")
...
folder_of_source = os.path.join(os.getcwd(), "space_of_language_0", "new_folder_" + str(counter_0))
    ...
    while (counter_1 < len(files)):
        ...
        try:
            ...
            if (files[counter_1].endswith(".conllu")):
                ...
                print_conllu_info(sentences, file=os.path.join(dist_, files[counter_1].split(".conllu")[0] + ".txt"))
