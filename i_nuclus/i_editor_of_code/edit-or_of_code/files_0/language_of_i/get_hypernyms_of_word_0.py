...
while (counter_0 < len(list_of_word)):
    ...
    while (counter_1 < len(list_of_word[counter_0][1])):
        ...
        print(" " * (4 * 1) + f"{counter_1}. {list_of_word[counter_0][1][0][0]} :")
        
        
        while (counter_2 < len(list_of_word[counter_0][1][0][1])):
        
        
            counter_3 = 0
            
            
            print(" " * (4 * 2) + f"{list_of_word[counter_0][1][0][1][counter_3][0]}")
            
            while (counter_3 < len(list_of_word[counter_0][1][0][1][counter_3][1])):
                
                
                print(" " * (4 * 3) + f"{list_of_word[counter_0][1][0][1][counter_3][1]}")
