...
for synset in wn.all_synsets():
    ...
    for lemma in synset.lemmas():
        ...
        list_of_word = show_relations(list_of_word=list_of_word, word=word)
...
list_of_word = sort_element_0_0(l=list_of_word)
...
file = os.path.join(os.getcwd(), "space_0", "space_of_language_1", "relations_like_hypernyms_of_word_0.txt")
