    ...
    while (counter_1 < len(list_to_organize)):
        ...
        if (counter_3 >= len(organized_list_0)):
            ...
            if (counter_4 >= len(organized_list_1)):
                ...
                operation = f"((1 / {organized_list_1[counter_4][1]}) * {porcent_of_gain})"
                ...
                operation = f"((1 / {organized_list_0[counter_4][1]}) * {porcent_of_gain})"
            ...
            if (bool_0 == True):
                ...
                operation = f"({organized_list_0[counter_3][1]} * {porcent_of_gain})"
