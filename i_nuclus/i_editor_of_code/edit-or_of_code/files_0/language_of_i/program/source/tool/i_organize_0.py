    ...
    while (counter_1 < len(list_to_organize)):
        ...
        if (counter_3 >= len(organized_list_0)):
            ...
            if (counter_4 >= len(organized_list_1)):
                ...
                organized_list_1.append([list_to_organize[counter_0], (1 / organized_list_1[counter_4][1]), list_to_organize[counter_1]])
                ...
                organized_list_1.append([list_to_organize[counter_0], (1 / organized_list_0[counter_4][1]), list_to_organize[counter_1]])
