...
i_file_0_i = os.path.join(cwd, "i_image_5_i.png")
...
i_image_0_i = Image.open(i_file_0_i)
...
i_image_2_i.paste(i_image_0_i, (int(width * (1 / 5)), int(height // 4) * 0))


i_image_2_i.paste(i_image_0_i, (int(width * (1 / 5)), int(height // 4) * 1))


i_image_2_i.paste(i_image_0_i, (int(width * (1 / 5)), int(height // 4) * 2))


i_image_2_i.paste(i_image_0_i, (int(width * (1 / 5)), int(height // 4) * 3))
