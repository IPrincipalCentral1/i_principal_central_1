...
i_image_2_i.paste(i_image_0_i, (int(width * (4 / 5)), int(height // 4) * 1))


i_image_2_i.paste(i_image_0_i, (int(width * (4 / 5)), int(height // 4) * 2))


i_image_2_i.paste(i_image_0_i, (int(width * (4 / 5)), int(height // 4) * 3))
