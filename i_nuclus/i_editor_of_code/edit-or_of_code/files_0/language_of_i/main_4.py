...
while (counter_0 < len(list_of_link)):
    ...
    if (list_of_link[counter_0].startswith("https://github.com/")):
        ...
        link = "https://github.com/" + v_1[0] + "/" + v_1[1] + "/archive/refs/heads/master.git"
        ...
        link = "http://github.com/" + v_1[0] + "/" + v_1[1] + "/archive/refs/heads/master.git"
...
url = list_of_link_of_repozitory[0]


#folder_0 = os.path.join(os.getcwd(), "space_of_language_0", "new_folder")
...
#https://github.com/UniversalDependencies/UD_English-GUM/archive/refs/heads/master.git

#https://github.com/UniversalDependencies/UD_English-GUM/archive/refs/heads/main.git
