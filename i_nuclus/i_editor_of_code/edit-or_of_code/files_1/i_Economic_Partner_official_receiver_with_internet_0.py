...
if (i["i am you"] == True):
    ...
    try:
        ...
        i["folder_of_files_that_have_been_received_into_it"] = "/mnt/795EE18952C91665/shared_directory_on_PC/my_link_updated/i_nuclus/mains/i_Economic_Partner_official_send_and_receive/i_github/i_principal_central/i/i_main"
        
        
        #i["folder_of_organize_the_money_on_it"] = "___folder_of_organize_the_money_on_it___"
        
        
        
        
        i["folder_of_organize_the_money_on_it"] = "/mnt/795EE18952C91665/shared_directory_on_PC/my_link_updated/i_nuclus/mains/i_Economic_Partner_official_send_and_receive/i_github/i_principal_central/i/new_folder_0"
        
        
        i["i_folder_for_receive"] = i["folder_of_organize_the_money_on_it"]
        ...
        if (len(i["i_file-s"]) > 0):
            ...
            while (i["i_counter"] < len(i["i_file-s"])):
                ...
                if (os.path.exists(pa.path.join(i["i_folder_for_receive"], i["i_file"]))):
