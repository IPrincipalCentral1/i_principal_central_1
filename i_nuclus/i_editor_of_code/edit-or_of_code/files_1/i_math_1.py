...
if (i["i am you"] == True):
    ...
    def invers_cos(a, type_of_angle=""):
    ...
    def invers_sin(b, type_of_angle=""):
                ...
                if (bool_0 == False):
                    ...
                    if (bool_1 == False):
                        ...
                        if ((m_2[0] == False) and (m_1[0] == False)):
                            ...
                            print(f"a_positive = {a_positive}")
                            
                            
                            print(f"a_negative = {a_negative}")
    ...
    if __name__ == "__main__":
        ...
        oper = invers_sin(b="(3 / (4))", type_of_angle="")
