...
if (i["i am you"] == True):
    ...
    if __name__ == "__main__":
        ...
        print("operation = '", operation, "' . error = ", result[0], " . result = ", result[1], " . number_of_digit_after_the_floating_point_ = ", number_of_digit_after_the_floating_point, " . time = ", t2 - t1)
