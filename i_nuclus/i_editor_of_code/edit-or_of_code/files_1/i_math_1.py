...
if (i["i am you"] == True):
    ...
    if __name__ == "__main__":
        ...
        '''
            ...
            If you want to calculate something specific, I can help. Replace ___operation___ With the operation you want to calculate. 
            
            And replace ___number_of_digit_after_the_floating_point___ with the precision that you want me to calculate the operation .
            
            
            If you want to know the difference between two numbers : 
            
                
                replace ___number_0___ with the first number .
                
                
                replace ___number_1___ with the second number .
            ...
            obligation :
                ...
                ( ___number_of_digit_after_the_floating_point___ >= 0 )
                


            
            You should definitely keep a copy of this file in a safe place.
            ...
            I have a discovery. Or a point of view about cos and sin .
            
            If you want to use these two functions, you can use them with me .
        
            i can work with degree : like ( 360 degree )
            
                you should make this : type_of_angle="degree" 
            
        
            i can work with grad : like ( 400 grad )
            
            
                you should make this : type_of_angle="grad" 
        
        
        
            you should replace ___alpha___ by the angle that you want to calculate .
            ...
            I have a discovery. Or a point of view about invers_cos and invers_sin . those are the invers successively of cos and sin .
            ...
            i can work with degree : like ( 360 degree )
                ...
                so you should replace ___type_degree___ by degree
            ...
            i can work with grad : like ( 400 grad )
                ...
                so you should replace ___type_degree___ by grad
                
                
                
            
            
            you should replace ___a___ by a to calculate .
            
            
            you should replace ___b___ by b to calculate .
            ...
            I have a discovery. Or a point of view about invers_cos_1 and invers_sin_1 . those are the invers successively of cos and sin .
            
            but it will work just in the first (1 / 4) from the circle .
        ...
        try:
            ...
            number_of_digit_after_the_floating_point = int("___number_of_digit_after_the_floating_point___")
        ...
        try:
            ...
            result = calculatrice_2(s=operation, l_=[], n=0, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point, e=False)
            
            t2 = time.time()
            
            print("operation = '", operation, "' . error = ", result[0], " . result = ", result[1], " . number_of_digit_after_the_floating_point = ", number_of_digit_after_the_floating_point, " . time = ", t2 - t1)
        ...
        try:
            ...
            result_0 = cos(alpha_=alpha, number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point, type_of_angle="___type_degree___")
        ...
        try:
            ...
            result_1 = sin(alpha_=alpha, number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point, type_of_angle="___type_degree___")
        ...
        try: 
            ...
            oper = invers_cos(a="___a___", b="___b___", number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point_1, type_of_angle="___type_degree___")
            
                        
            
            t1 = time.time()
            
            result = calculatrice_2(s=oper, l_=[], n=0, number_of_digit_after_the_floating_point_=number_of_digit_after_the_floating_point, e=False)
            
            t2 = time.time()
            
            print("oper = '", oper, "' . error = ", result[0], " . result = ", result[1], " . number_of_digit_after_the_floating_point = ", number_of_digit_after_the_floating_point, " . time = ", t2 - t1)
        ...
        try: 
            ...
            oper = invers_sin(a="___a___", b="___b___", number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point_1, type_of_angle="___type_degree___")
        ...
        try: 
            ...
            oper = invers_cos_1(a="___a___", number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point_1, type_of_angle="___type_degree___")
        ...
        try: 
            ...
            oper = invers_sin_1(b="___b___", number_of_digit_after_the_floating_point_1=number_of_digit_after_the_floating_point_1, type_of_angle="___type_degree___")
