...
if (i["i am you"] == True):
    ...
    print("finish .")
                ...
                i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(i_self.i["i_cwd"], "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money")
                ...
                while ((os.path.exists(os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_" + str(i_self.i["i_counter_5"]))))):


                    i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_" + str(i_self.i["i_counter_5"]))
                ...
                i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(i_self.i["i_cwd"], "i_folder_of_i_principal_central", "i_folder_of_image_i_unity")
                ...
                while ((os.path.exists(os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_" + str(i_self.i["i_counter_5"]))))):


                    i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_" + str(i_self.i["i_counter_5"]))
    ...
    def i_get_list_of_i_unity(i_self, folder_of_source_of_unity):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_i_unity")
            ...
            while ((os.path.exists(os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_" + str(i_self.i["i_counter_5"]))))):


                i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_" + str(i_self.i["i_counter_5"]))
    ...
    def i_get_list_of_i_money(i_self, folder_of_source_of_unity):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money")
            ...
            while ((os.path.exists(os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_" + str(i_self.i["i_counter_5"]))))):


                i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_" + str(i_self.i["i_counter_5"]))
    ...
    def i_print_from_money(i_self, i_unity, i_quantity, i_folder, i_number, folder_of_source_of_unity):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            while ((i_self.i["i_semaphore_of_get_unity"] == False) and (os.path.exists(os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_" + str(i_self.i["i_counter_5"]))))):
            ...
            if (i_self.i["i_semaphore_of_get_unity"] == True):
                ...
                i_self.i["i_counter_3"] = 0


                while (i_self.i["i_counter_3"] < i_number):
    ...
    def i_print_from_unity(i_self, i_unity, i_quantity, i_folder, i_number, folder_of_source_of_unity):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            while ((i_self.i["i_semaphore_of_get_unity"] == False) and (os.path.exists(os.path.join(folder_of_source_of_unity, "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_" + str(i_self.i["i_counter_5"]))))):
...
#                    print(f"i_hello . i am in : i_print_from_unity . i_number = {i_number} .")
