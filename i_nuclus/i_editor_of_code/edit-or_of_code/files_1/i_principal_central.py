...
if (i["i am you"] == True):
    ...
    def i_get_list_of_i_unity(i_self):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            i_self.i["i_path_of_image-s_of_i_unity"] = os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_i_unity")
    ...
    def i_get_list_of_i_money(i_self):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            i_self.i["i_path_of_image-s_of_i_money"] = os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money")
    ...
    def i_print_from_money(i_self, i_unity, i_quantity, i_folder, i_number):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            while ((i_self.i["i_semaphore_of_get_unity"] == False) and (os.path.exists(os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_of_i_money_" + str(i_self.i["i_counter_5"]))))):
    ...
    def i_print_from_unity(i_self, i_unity, i_quantity, i_folder, i_number):
        ...
        if ((i_self.i["i am you"] == True) and (i_self.i["i develope"] == True)):
            ...
            while ((i_self.i["i_semaphore_of_get_unity"] == False) and (os.path.exists(os.path.join(os.getcwd(), "i_folder_of_i_principal_central", "i_folder_of_image_i_unity_" + str(i_self.i["i_counter_5"]))))):
    ...
    def re_arange(self, folder, folder_of_temporarly):
...
#                    print(f"number_of_single_digit = {number_of_single_digit} . element[0] = {element[0]} . new_folder = {new_folder} .")
    ...
    def print_specific_amount(self, element, folder):
        ...
        list_of_i_unity = self.i_get_quanity_from_unity(i_unity=element[0])
    ...
    #                print(f"number_of_single_digit = {number_of_single_digit} . element[0] = {element[0]} . folder = {folder} .")
            ...
            list_of_i_money = self.i_get_quanity_from_money(i_unity=element[0])
...
#                    print(f"self.my_int(_) = {self.my_int(1234.0)} . element_0 = {element_0} . element_1 = {element_1} . element_2 = {element_2} .")
                    ...
                    l_error = self.print_specific_amount(element=element_1, folder=folder_from)
                    ...
                    if (len(l_error) == 0):
                        ...
                        l_error = self.print_specific_amount(element=element_2, folder=folder_to)
