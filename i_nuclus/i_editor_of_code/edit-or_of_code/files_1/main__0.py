...
var_0 = i["i_class"].print_specific_amount(element=["I", 10 ** 200], folder=os.path.join(cwd, "new_folder"))
...
var_0 = i["i_class"].print_specific_amount(element=["I", 11], folder=os.path.join(cwd, "new_folder"))
...
i["i_class"].i_print_from_unity(i_unity="I", i_quantity=10, i_folder=new_folder_2, i_number=2)
...
var_of_re_arange = i["i_class"].re_arange(folder=new_folder_2, folder_of_temporarly=new_folder_of_temporarly)
...
i["i_i_calcul_from_folder"] = i["i_class"].extract_cash(folder_from=new_folder_2, folder_to=new_folder, unity="I", quantity=9)
...
i["i_class"].i_print_from_money(i_unity="USD", i_quantity=1, i_folder=os.path.join(cwd, "i", "i_main"), i_number=2)
...
i["i_class"].i_print_from_unity(i_unity="I", i_quantity=1, i_folder=os.path.join(cwd, "i", "i_main"), i_number=2)



i["i_class"].i_print_from_unity(i_unity="Point", i_quantity=1, i_folder=os.path.join(cwd, "i", "i_main"), i_number=2)
