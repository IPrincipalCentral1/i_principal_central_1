...
def create_transparent_image(path, width=100, height=100):
    # صورة شفافة تماماً
    img = Image.new("RGBA", (width, height), (0, 255, 255, 0))  # سماوي شفاف جداً
    img.save(path)
...
class My3DViewer(QWidget):
    def __init__(self):
        ...
        create_transparent_image(img_path, 100, 100)
