...
def put_point(image, x_0, y_0, color, border):
    ...
    while (y_1 < image.size[1]):
        ...
        while (x_1 < image.size[0]):
            ...
            var_bool_0 = (x_1 <= x_0 - border)
            
            
            var_bool_1 = (x_0 + border <= x_1)
            
            
            var_bool_2 = (y_1 <= y_0 - border)
                
            
            var_bool_3 = (y_0 + border <= y_1)
    ...
    while (y < height):
        ...
        while (x < width):
            ...
            if (x == y):
                ...
                put_point(image=image, x_0=x, y_0=y, color=(255, 0, 0, color[3]), border=10)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        create_image(path_of_file=self.image_path, width=100, height=100, color=(0, 255, 255, 128))
