...
def create_image(path_of_file, width, height, color, flip):
        ...
        while (x < width):
            ...
            if (flip == True):
                ...
                if (x == y):
                    ...
                    image.putpixel((width - x - 1, y), (255, 0, 0, color[3]))
...
class GLBoxWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        create_image(path_of_file=file_of_image, width=10, height=10, color=(0, 255, 255, 128), flip=True)
        
        
                
        file_of_image = os.path.join(os.getcwd(), "front.png")
        
        create_image(path_of_file=file_of_image, width=10, height=10, color=(0, 255, 255, 128), flip=False)
    ...
    #def draw_textured_box(self, w, h, d):
        ## نصف الأبعاد
        #w /= 2
        #h /= 2
        #d /= 2
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("3D Textured Box")
...
#class GLWidget(QOpenGLWidget):
    ...
    #def paintGL(self):
        ...
        #self.drawTexturedBox(self.texture_id, width=2.0, height=2.0, depth=1)
    ...
    #def drawTexturedBox(self, texture_id, width=2.0, height=2.0, depth=0.2):
